...
final class ag extends BitmapDrawable
{
    ...
    ag(Context context, Bitmap bitmap, Drawable drawable, ae ae1, boolean flag, boolean flag1)
    {
    ...
    static void a(ImageView imageview, int i, Drawable drawable)
    {
        if (i != 0)
        {
    ...
    static void a(ImageView imageview, Context context, Bitmap bitmap, ae ae1, boolean flag, boolean flag1)
    {
        ...
        imageview.setImageDrawable(new ag(context, bitmap, drawable, ae1, flag, flag1));
    }
