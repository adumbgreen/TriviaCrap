...
class b extends Thread
{
    ...
    public void run()
    {
        ...
        } else
        {
            a.b.post(new Runnable(b) {
                ...
                final InterstitialImageView._cls4 a;
                private final String b;

                public void run()
                {
                    InterstitialImageView.a(InterstitialImageView._cls4.a(a)).loadUrl(b);
                }

            
            {
                a = InterstitialImageView._cls4.this;
                b = s;
                super();
            }
            });
    ...
    _cls1.b(InterstitialImageView interstitialimageview, String s)
    {
