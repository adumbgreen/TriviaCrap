...
public class ct
{
    ...
    public int a(String s, String s1)
    {
        ...
        {
            fx.c("IInAppBillingService is not available, please add com.android.vending.billing.IInAppBillingService to project.", exception);
            return 5;
        }
        return i;
    }
    ...
    public void a(IBinder ibinder)
    {
        ...
        {
            fx.e("IInAppBillingService is not available, please add com.android.vending.billing.IInAppBillingService to project.");
        }
    }
