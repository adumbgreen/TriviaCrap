...
public final class cv extends df
{
    ...
    public cv(String s, ArrayList arraylist, Context context, String s1)
    {
        c = s;
        d = arraylist;
        a = s1;
    ...
    private void b()
    {
        ...
        {
            fx.e("Google Conversion Tracking SDK 1.2.0 or above is required to report a conversion.");
            return;
        }
        ...
        {
            fx.c("Fail to report a conversion.", exception);
        }
    }
...
_L2:
        long l;
        l = SystemClock.elapsedRealtime() - fj.d().a();
        ...
        fx.c("Error to retrieve app version", namenotfoundexception);
        s2 = "";
...
_L1:
    ...
    public void b(int i)
    {
        ...
        hashmap.put("sku", c);
        String s;
        for (Iterator iterator = d.iterator(); iterator.hasNext(); (new fv(b, a, a(s, hashmap))).e())
        {
