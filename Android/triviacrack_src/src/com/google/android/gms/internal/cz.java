...
public class cz
{
    ...
    {
        b = new da(this, context, "google_inapp_purchase.db");
    }
    ...
    public SQLiteDatabase a()
    {
        ...
        {
            fx.e("Error opening writable conversion tracking database");
            return null;
        }
    ...
    public cx a(Cursor cursor)
    {
        ...
        {
            return new cx(cursor.getLong(0), cursor.getString(1), cursor.getString(2));
        }
    }
...
_L2:
        ...
        cursor = null;
_L5:
        fx.e((new StringBuilder()).append("Error extracing purchase info: ").append(sqliteexception.getMessage()).toString());
...
_L2:
        ...
        SQLiteException sqliteexception;
        sqliteexception;
        fx.e((new StringBuilder()).append("Error getting record count").append(sqliteexception.getMessage()).toString());
        if (cursor == null) goto _L2; else goto _L1
_L1:
        cursor.close();
          goto _L2
    ...
    public void b(cx cx1)
    {
        ...
        contentvalues.put("product_id", cx1.c);
        contentvalues.put("developer_payload", cx1.b);
        contentvalues.put("record_time", Long.valueOf(SystemClock.elapsedRealtime()));
        cx1.a = sqlitedatabase.insert("InAppPurchase", null, contentvalues);
        if ((long)b() > 20000L)
        {
            c();
        }
...
_L2:
        ...
        cursor = null;
_L4:
        fx.e((new StringBuilder()).append("Error remove oldest record").append(sqliteexception.getMessage()).toString());
        if (cursor == null) goto _L2; else goto _L1
_L1:
        cursor.close();
          goto _L2
