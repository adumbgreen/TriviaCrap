...
public final class GooglePlayServicesUtil
{
    ...
    public static final int GOOGLE_PLAY_SERVICES_VERSION_CODE = 0x4d7808;
    ...
    public static Intent Z(int i)
    {
        ...
        case 1: // '\001'
        case 2: // '\002'
            return hn.b("com.google.android.gms");

        case 3: // '\003'
            return hn.a("com.google.android.gms");
    ...
    {
        if (!com.google.android.gms.internal.if.c()) goto _L2; else goto _L1
_L1:
...
_L5:
        ...
        if (fragment == null)
        {
            gx1 = new gx(activity, intent, j);
        } else
        {
            gx1 = new gx(fragment, intent, j);
        }
        s = e(activity, i);
        if (s != null)
        {
            builder.setPositiveButton(s, gx1);
        }
        switch (i)
        {
        default:
        ...
        case 1: // '\001'
            return builder.setTitle(d.common_google_play_services_install_title).create();

        case 3: // '\003'
            return builder.setTitle(d.common_google_play_services_enable_title).create();

        case 2: // '\002'
            return builder.setTitle(d.common_google_play_services_update_title).create();

        case 9: // '\t'
            Log.e("GooglePlayServicesUtil", "Google Play services is invalid. Cannot recover.");
            return builder.setTitle(d.common_google_play_services_unsupported_title).create();

        case 7: // '\007'
            Log.e("GooglePlayServicesUtil", "Network error occurred. Please retry request later.");
            return builder.setTitle(d.common_google_play_services_network_error_title).create();
        ...
        case 5: // '\005'
            ...
            return builder.setTitle(d.common_google_play_services_invalid_account_title).create();
...
_L4:
    ...
    public static boolean a(PackageManager packagemanager, PackageInfo packageinfo)
    {
        ...
        if (packageinfo != null)
        {
            ...
            byte abyte0[] = a(packageinfo, Db);
            flag1 = false;
            if (abyte0 != null)
            {
                flag1 = flag;
            }
            if (!flag1 && a(packageinfo, Da) != null)
            {
    ...
    public static boolean a(Resources resources)
    {
        if (resources != null)
        {
            ...
            if (com.google.android.gms.internal.if.a() && flag || b(resources))
            {
                return true;
            }
        }
    ...
    public static boolean b(int i, Activity activity, Fragment fragment, int j, android.content.DialogInterface.OnCancelListener oncancellistener)
    {
        ...
        if (flag)
        {
            ...
            h.a(dialog, oncancellistener).show(fragmentmanager1, "GooglePlayServicesErrorDialog");
        } else
        if (com.google.android.gms.internal.if.a())
        {
            android.app.FragmentManager fragmentmanager = activity.getFragmentManager();
            com.google.android.gms.common.b.a(dialog, oncancellistener).show(fragmentmanager, "GooglePlayServicesErrorDialog");
        } else
        {
...
_L4:
    ...
    private static boolean b(Resources resources)
    {
        ...
        boolean flag = com.google.android.gms.internal.if.b();
        boolean flag1 = false;
        if (flag)
        {
    ...
    public static String d(Context context, int i)
    {
        ...
        case 1: // '\001'
            ...
            {
                return resources.getString(d.common_google_play_services_install_text_tablet);
            } else
            {
                return resources.getString(d.common_google_play_services_install_text_phone);
            }
        ...
        case 2: // '\002'
            return resources.getString(d.common_google_play_services_update_text);
        ...
        case 12: // '\f'
            return resources.getString(d.common_google_play_services_unsupported_date_text);
        }
    }
    ...
    public static String f(Context context, int i)
    {
        ...
        case 1: // '\001'
            return resources.getString(d.common_google_play_services_notification_needs_installation_title);

        case 2: // '\002'
            return resources.getString(d.common_google_play_services_notification_needs_update_title);

        case 3: // '\003'
            return resources.getString(d.common_google_play_services_needs_enabling_title);
    ...
    public static int isGooglePlayServicesAvailable(Context context)
    {
        ...
        if (ie.c(packageinfo.versionCode))
        {
    ...
    abyte0
        ...
        int i = ie.a(0x4d7808);
        if (ie.a(packageinfo.versionCode) < i)
        {
            Log.w("GooglePlayServicesUtil", (new StringBuilder()).append("Google Play services out of date.  Requires 5077000 but found ").append(packageinfo.versionCode).toString());
            return 2;
        }
    ...
    {
        Resources resources = context.getResources();
        Notification notification = new Notification(0x108008a, resources.getString(d.common_google_play_services_notification_ticker), System.currentTimeMillis());
        notification.flags = 0x10 | notification.flags;
        String s = f(context, i);
        String s1 = y(context);
        notification.setLatestEventInfo(context, s, resources.getString(d.common_google_play_services_error_notification_requested_by_msg, new Object[] {
            s1
    ...
    public static void w(Context context)
    {
        ...
        if (i != 0)
        {
            ...
            {
                throw new g(i, "Google Play Services not available", intent);
            }
        } else
        {
            return;
