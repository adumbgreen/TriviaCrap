...
_L5:
    ...
    private class GetTokenAuthHandler extends AuthHandler
    {
        ...
        boolean tryAuthorize(final AuthorizationRequest request)
        {
            ...
            {
                notifyBackgroundProcessingStart();
                com.facebook.internal.PlatformServiceClient.CompletedListener completedlistener = new com.facebook.internal.PlatformServiceClient.CompletedListener() {
...
_L1:
    ...
    private class WebViewAuthHandler extends AuthHandler
    {
        ...
        boolean tryAuthorize(final AuthorizationRequest request)
        {
            ...
            oncompletelistener = new com.facebook.widget.WebDialog.OnCompleteListener() {
