...
_L1:
        ...
        {
            datapersister2 = DataPersisterManager.lookupForField(field1);
        } else
        {
            Method method;
            Object obj;
            ...
            {
                throw SqlExceptionUtil.create((new StringBuilder()).append("Could not find getSingleton static method on class ").append(class4).toString(), exception);
            }
            try
            {
            ...
            {
                throw SqlExceptionUtil.create((new StringBuilder()).append("Could not run getSingleton method on class ").append(class4).toString(), invocationtargetexception.getTargetException());
            }
            catch (Exception exception1)
            {
                throw SqlExceptionUtil.create((new StringBuilder()).append("Could not run getSingleton method on class ").append(class4).toString(), exception1);
            }
            if (obj == null)
            {
                throw new SQLException((new StringBuilder()).append("Static getSingleton method should not return null on class ").append(class4).toString());
            }
            try
            {
            ...
            {
                throw SqlExceptionUtil.create((new StringBuilder()).append("Could not cast result of static getSingleton method to DataPersister from class ").append(class4).toString(), exception2);
            }
        }
...
_L2:
        ...
        if (!datapersister.isValidForField(field1))
        {
            ...
            if (class3 != null)
            {
                stringbuilder.append((new StringBuilder()).append(", maybe should be ").append(class3).toString());
            }
...
_L3:
        ...
        {
            throw new IllegalArgumentException((new StringBuilder()).append("Field ").append(this).append(" is a primitive class ").append(class2).append(" but marked as foreign").toString());
        }
        if (s1 == null)
        {
        ...
        {
            throw new SQLException((new StringBuilder()).append("Field '").append(field1.getName()).append("' in class ").append(class2).append("' should use the @").append(com/j256/ormlite/field/ForeignCollectionField.getSimpleName()).append(" annotation not foreign=true").toString());
        }
          goto _L6
_L4:
...
_L8:
        ...
        if (datapersister1 == null && !databasefieldconfig.isForeignCollection())
        {
            ...
            {
                throw new SQLException((new StringBuilder()).append("ORMLite does not know how to store ").append(class2).append(" for field '").append(field1.getName()).append("'. byte[] fields must specify dataType=DataType.BYTE_ARRAY or SERIALIZABLE").toString());
            }
            if (java/io/Serializable.isAssignableFrom(class2))
            {
                throw new SQLException((new StringBuilder()).append("ORMLite does not know how to store ").append(class2).append(" for field '").append(field1.getName()).append("'.  Use another class, custom persister, or to serialize it use ").append("dataType=DataType.SERIALIZABLE").toString());
            } else
            {
                throw new IllegalArgumentException((new StringBuilder()).append("ORMLite does not know how to store ").append(class2).append(" for field ").append(field1.getName()).append(". Use another class or a custom persister.").toString());
            }
        }
        s3 = s2;
...
label0:
        ...
        if (isGeneratedId)
        {
            throw new SQLException((new StringBuilder()).append("Field '").append(field.getName()).append("' cannot be a generatedId and have a default value '").append(s).append("'").toString());
        } else
        {
...
_L2:
        ...
        if (fieldSetMethod == null)
        {
            ...
            {
                throw SqlExceptionUtil.create((new StringBuilder()).append("Could not assign object '").append(obj1).append("' to field ").append(this).toString(), illegalargumentexception);
            }
            catch (IllegalAccessException illegalaccessexception)
            {
                throw SqlExceptionUtil.create((new StringBuilder()).append("Could not assign object '").append(obj1).append("' to field ").append(this).toString(), illegalaccessexception);
            }
        }
...
_L7:
        ...
        {
            throw SqlExceptionUtil.create((new StringBuilder()).append("Could not call ").append(fieldSetMethod).append(" on object with '").append(obj1).append("' for ").append(this).toString(), exception);
        }
    }
    ...
    public void configDaoInformation(ConnectionSource connectionsource, Class class1)
    {
        ...
        if (fieldConfig.isForeignAutoRefresh() || s != null)
        {
            ...
            if (s == null)
            {
                ...
                if (fieldtype1 == null)
                {
                    throw new IllegalArgumentException((new StringBuilder()).append("Foreign field ").append(class2).append(" does not have id field").toString());
                }
            } else
            {
                ...
                if (fieldtype1 == null)
                {
                    throw new IllegalArgumentException((new StringBuilder()).append("Foreign field ").append(class2).append(" does not have field named '").append(s).append("'").toString());
                }
            }
        ...
        if (fieldConfig.isForeign())
        {
            ...
            {
                throw new IllegalArgumentException((new StringBuilder()).append("Field ").append(field.getName()).append(", if foreignAutoCreate = true then class ").append(class2.getSimpleName()).append(" must have id field with generatedId = true").toString());
            }
            tableinfo = tableinfo1;
        ...
        if (fieldConfig.isForeignCollection())
        {
            ...
            {
                throw new SQLException((new StringBuilder()).append("Field class for '").append(field.getName()).append("' must be a parameterized Collection whose generic argument is an entity class not: ").append(atype[0]).toString());
            }
    ...
    public Object extractRawJavaFieldValue(Object obj)
    {
        if (fieldGetMethod == null)
        {
            ...
            {
                throw SqlExceptionUtil.create((new StringBuilder()).append("Could not get field value for ").append(this).toString(), exception1);
            }
            return obj2;
        }
        Object obj1;
        ...
        {
            throw SqlExceptionUtil.create((new StringBuilder()).append("Could not call ").append(fieldGetMethod).append(" for ").append(this).toString(), exception);
        }
        return obj1;
    }
