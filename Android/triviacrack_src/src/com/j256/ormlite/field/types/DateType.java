...
public class DateType extends BaseDateType
{
    ...
    public Object parseDefaultString(FieldType fieldtype, String s)
    {
        ...
        {
            throw SqlExceptionUtil.create((new StringBuilder()).append("Problems parsing default date string '").append(s).append("' using '").append(datestringformatconfig).append('\'').toString(), parseexception);
        }
        return timestamp;
    }
