...
public class SerializableType extends BaseDataType
{
    ...
    public Object javaToSqlArg(FieldType fieldtype, Object obj)
    {
        ...
        exception;
_L4:
        throw SqlExceptionUtil.create((new StringBuilder()).append("Could not write serialized object to byte array: ").append(obj).toString(), exception);
        exception1;
_L2:
...
_L4:
        throw SqlExceptionUtil.create((new StringBuilder()).append("Could not read serialized object from byte array: ").append(Arrays.toString(abyte0)).append("(len ").append(abyte0.length).append(")").toString(), exception);
        exception1;
_L2:
        if (objectinputstream != null)
        {
