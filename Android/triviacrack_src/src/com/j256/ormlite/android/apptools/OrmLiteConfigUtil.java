...
label0:
        ...
        String s2 = s1.substring(0, s1.length() - ".java".length());
...
_L5:
        ...
        throwable1;
        System.err.println((new StringBuilder()).append("Could not load inner classes for: ").append(class1).toString());
        System.err.println((new StringBuilder()).append("     ").append(throwable1).toString());
          goto _L4
    }
    ...
    private static File findResRawDir(File file)
    {
        ...
        for (int j = 0; j < i; j++)
        {
            ...
            File afile1[] = file1.listFiles(new FileFilter() {
...
_L2:
        ...
        {
            System.err.println((new StringBuilder()).append("Skipping ").append(class1).append(" because we got an error finding its definition: ").append(error.getMessage()).toString());
            return;
        }
        for (j = 0; j >= i; j++)
        {
