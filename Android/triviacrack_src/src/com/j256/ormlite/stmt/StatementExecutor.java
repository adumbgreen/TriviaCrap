    ...
    implements GenericRowMapper
{
    ...
    public SelectIterator buildIterator(BaseDaoImpl basedaoimpl, ConnectionSource connectionsource, PreparedStmt preparedstmt, ObjectCache objectcache, int i)
    {
        ...
        SelectIterator selectiterator = new SelectIterator(tableInfo.getDataClass(), basedaoimpl, preparedstmt, connectionsource, databaseconnection, compiledstatement, preparedstmt.getStatement(), objectcache);
        if (false)
        {
            null.close();
        }
