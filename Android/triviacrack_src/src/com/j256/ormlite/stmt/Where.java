...
public class Where
{
    ...
    private transient Where in(boolean flag, String s, Object aobj[])
    {
        if (aobj.length == 1)
        {
            ...
            {
                StringBuilder stringbuilder2 = (new StringBuilder()).append("Object argument to ");
                String s3;
                if (flag)
                {
                    s3 = "IN";
                ...
                throw new IllegalArgumentException(stringbuilder2.append(s3).append(" seems to be an array within an array").toString());
            }
            if (aobj[0] instanceof Where)
            {
                StringBuilder stringbuilder1 = (new StringBuilder()).append("Object argument to ");
                String s2;
                if (flag)
                {
                    s2 = "IN";
            ...
            {
                StringBuilder stringbuilder = (new StringBuilder()).append("Object argument to ");
                String s1;
                if (flag)
                {
                    s1 = "IN";
                ...
                throw new IllegalArgumentException(stringbuilder.append(s1).append(" seems to be a prepared statement, did you mean the QueryBuilder?").toString());
            }
        }
    ...
    private void push(Clause clause)
    {
        ...
        {
            Clause aclause1[] = new Clause[2 * clauseStackLevel];
