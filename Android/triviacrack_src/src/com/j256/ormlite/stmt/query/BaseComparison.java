    ...
    implements Comparison
{
    ...
    protected void appendArgOrValue(DatabaseType databasetype, FieldType fieldtype, StringBuilder stringbuilder, List list, Object obj)
    {
        ...
        if (fieldtype.isForeign())
        {
            ...
            {
                throw new SQLException((new StringBuilder()).append("Foreign field ").append(fieldtype).append(" does not seem to be producing a numerical value '").append(s).append("'. Maybe you are passing the wrong object to comparison: ").append(this).toString());
            }
