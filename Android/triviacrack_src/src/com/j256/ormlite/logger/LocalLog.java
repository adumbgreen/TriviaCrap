    ...
    public LocalLog(String s)
    {
        ...
        if (level2 == null)
        {
            ...
            } else
            {
                ...
                {
                    throw new IllegalArgumentException((new StringBuilder()).append("Level '").append(s1).append("' was not found").toString(), illegalargumentexception);
                }
                level2 = level3;
            }
        }
...
_L2:
        ...
        if (as.length != 2)
        {
            System.err.println((new StringBuilder()).append("Line is not in the format of 'pattern = level': ").append(s).toString());
...
_L1:
    ...
    static List readLevelResourceFile(InputStream inputstream)
    {
        ...
        return list;
        ioexception1;
        System.err.println((new StringBuilder()).append("IO exception reading the log properties file '/ormliteLocalLog.properties': ").append(ioexception1).toString());
        try
        {
            inputstream.close();
        }
