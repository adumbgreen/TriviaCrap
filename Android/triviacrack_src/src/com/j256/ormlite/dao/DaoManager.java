...
_L6:
        ...
        exception1;
        throw SqlExceptionUtil.create((new StringBuilder()).append("Could not call the constructor in class ").append(class2).toString(), exception1);
          goto _L1
    }
    ...
    private static Dao doCreateDao(ConnectionSource connectionsource, DatabaseTableConfig databasetableconfig)
    {
        ...
        if (dao == null)
        {
            ...
            } else
            {
                ...
                if (constructor == null)
                {
                    throw new SQLException((new StringBuilder()).append("Could not find public constructor with ConnectionSource, DatabaseTableConfig parameters in class ").append(class2).toString());
                }
                try
                {
                ...
                {
                    throw SqlExceptionUtil.create((new StringBuilder()).append("Could not call the constructor in class ").append(class2).toString(), exception);
                }
            }
