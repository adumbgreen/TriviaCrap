    ...
    implements Dao
{
    ...
    private CloseableIterator createIterator(PreparedQuery preparedquery, int i)
    {
        ...
        {
            throw SqlExceptionUtil.create((new StringBuilder()).append("Could not build prepared-query iterator for ").append(dataClass).toString(), sqlexception);
        }
        return selectiterator;
    }
...
_L6:
    ...
    public transient GenericRawResults queryRaw(String s, RawRowMapper rawrowmapper, String as[])
    {
        ...
        {
            throw SqlExceptionUtil.create((new StringBuilder()).append("Could not perform raw query for ").append(s).toString(), sqlexception);
        }
    ...
    public transient long queryRawValue(String s, String as[])
    {
        ...
        SQLException sqlexception;
        sqlexception;
        throw SqlExceptionUtil.create((new StringBuilder()).append("Could not perform raw value query for ").append(s).toString(), sqlexception);
        Exception exception;
        exception;
        connectionSource.releaseConnection(databaseconnection);
        throw exception;
...
_L3:
    ...
    public transient int updateRaw(String s, String as[])
    {
        ...
        SQLException sqlexception;
        sqlexception;
        throw SqlExceptionUtil.create((new StringBuilder()).append("Could not run raw update statement ").append(s).toString(), sqlexception);
        Exception exception;
        exception;
        connectionSource.releaseConnection(databaseconnection);
        throw exception;
