...
public class JavaxPersistence
{
    ...
    public static DatabaseFieldConfig createFieldConfig(DatabaseType databasetype, Field field)
    {
        ...
        {
            throw SqlExceptionUtil.create((new StringBuilder()).append("Problem accessing fields from the @Column annotation for field ").append(field).toString(), exception4);
        }
        if (s3 == null)
        {
...
_L1:
        ...
        {
            throw SqlExceptionUtil.create((new StringBuilder()).append("Problem accessing fields from the @Basic annotation for field ").append(field).toString(), exception3);
        }
...
_L9:
        ...
        {
            throw SqlExceptionUtil.create((new StringBuilder()).append("Problem accessing fields from the @JoinColumn annotation for field ").append(field).toString(), exception1);
        }
        if (s1 == null)
        {
...
_L6:
        ...
        {
            throw SqlExceptionUtil.create((new StringBuilder()).append("Problem accessing fields from the @Enumerated annotation for field ").append(field).toString(), exception);
        }
        if (obj == null)
        {
...
_L11:
        ...
        {
            throw SqlExceptionUtil.create((new StringBuilder()).append("Problem accessing fields from the @JoinColumn annotation for field ").append(field).toString(), exception2);
        }
        if (s2 == null)
        {
