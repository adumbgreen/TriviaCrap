...
_L1:
        return false;
_L2:
        AdContainer.access$400(_fld0).setImageDrawable(closePressed);
        continue; /* Loop/switch isn't completed */
_L3:
        AdContainer.access$400(_fld0).setImageDrawable(closeNormal);
    ...
    class AdContainer._cls2 extends AsyncTask
    {
        ...
        protected transient Void doInBackground(Void avoid[])
        {
            ...
            if (flag)
            {
                ...
                android.view.View.OnClickListener onclicklistener = new AdContainer._cls2._cls1();
                AdContainer.access$400(AdContainer.this).setOnClickListener(onclicklistener);
                AdContainer.access$300(AdContainer.this).setOnClickListener(onclicklistener);
                AdContainer._cls2._cls2 _lcls2 = new AdContainer._cls2._cls2();
                AdContainer.access$300(AdContainer.this).setOnTouchListener(_lcls2);
                AdContainer.access$400(AdContainer.this).setOnTouchListener(_lcls2);
...
_L9:
        ...
        // Unreferenced inner class com/amazon/device/ads/AdContainer$2$1

/* anonymous class */
        class AdContainer._cls2._cls1
