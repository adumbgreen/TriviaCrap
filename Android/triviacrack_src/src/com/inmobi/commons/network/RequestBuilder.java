...
_L1:
        ...
        if (!"".equals(s2.trim()))
        {
            stringbuffer.append((new StringBuilder()).append("&").append(s2).toString());
        }
        if (s3 == null)
        {
        ...
        if (!"".equals(s3.trim()))
        {
            stringbuffer.append((new StringBuilder()).append("&").append(s3).toString());
        }
        if (s4 == null)
        {
        ...
        if (s5 != null)
        {
            try
            {
                if (!"".equals(s5.trim()))
                {
                    stringbuffer.append((new StringBuilder()).append("&").append(s5).toString());
                }
            }
            catch (Exception exception)
            {
                Log.internal("[InMobi]-4.3.0", (new StringBuilder()).append("Exception occured in an ad request").append(exception).toString());
            }
        }
        return stringbuffer.toString();
        stringbuffer.append((new StringBuilder()).append("&").append(s1).toString());
          goto _L1
    }
...
_L1:
        ...
        String s = (new StringBuilder()).append("pr-SAND-").append(InternalSDKUtil.getInMobiInternalVersion("4.3.0")).append("-").append("20140428").toString();
        ...
        {
            Log.internal("[InMobi]-4.3.0", "Couldn't build post string in Request Builder", exception);
            return null;
        }
          goto _L1
        Exception exception1;
        exception1;
        Log.internal("[InMobi]-4.3.0", "Couldn't build post string in Request Builder", exception1);
        return s2;
    }
    ...
    public String getDevicePostBody()
    {
        ...
        try
        {
            ...
            stringbuilder.append((new StringBuilder()).append("&ts=").append(calendar.getTimeInMillis()).toString());
...
_L4:
        ...
        stringbuilder.append((new StringBuilder()).append("&c-ap-bssid=").append(wifiinfo.bssid).toString());
        ...
        if (!"".equals(s3))
        {
            stringbuilder.append((new StringBuilder()).append("&c-sid=").append(s3).toString());
        }
_L2:
        ...
        exception2;
        Log.internal("[InMobi]-4.3.0", "Couldn't get cell tower info in Request Builder", exception2);
        if (true) goto _L2; else goto _L1
_L1:
        Exception exception3;
        exception3;
        Log.internal("[InMobi]-4.3.0", "Couldn't build post string in Request Builder", exception3);
        return s1;
...
label0:
        ...
        return s2;
        exception;
        Log.internal("[InMobi]-4.3.0", "LTVID not available yet in configs");
        long1 = null;
        if (true) goto _L2; else goto _L1
_L1:
    }
