...
_L4:
        ...
        Log.debug("[InMobi]-[AdTracker]-4.3.0", (new StringBuilder()).append("Retrying goalname: ").append(s).append(" after ").append(l1 / 1000L).append(" secs").toString());
        synchronized (d)
        {
            Thread.sleep(l1);
        }
        ...
        {
            Log.internal("[InMobi]-[AdTracker]-4.3.0", "Failed to reduce wait time exception", exception);
        }
        return;
_L2:
        if (l1 > (long)i1)
...
_L3:
    ...
    private static void b(String s)
    {
        ...
        {
            Log.debug("[InMobi]-[AdTracker]-4.3.0", "Network Unavailable");
            j = 1;
            deinit();
            return;
        }
        ...
        {
            Log.internal("[InMobi]-[AdTracker]-4.3.0", "Failed to process IAT goals", exception);
        }
        return;
    }
    ...
    private static void g()
    {
        ...
        Log.internal("[InMobi]-[AdTracker]-4.3.0", "Getting wait time for referrer");
        l1 = j();
        Log.internal("[InMobi]-[AdTracker]-4.3.0", (new StringBuilder()).append("Waiting for referrer for ").append(l1).append("secs").toString());
        if (!i())
        {
            synchronized (d)
            {
        ...
        Log.internal("[InMobi]-[AdTracker]-4.3.0", (new StringBuilder()).append("Saving referrer from logs: ").append(s).toString());
        ...
        {
            Log.internal("[InMobi]-[AdTracker]-4.3.0", "Failed to set referrer", exception);
        }
        return;
    }
    ...
    private static boolean h()
    {
        ...
        Exception exception;
        exception;
        Log.internal("[InMobi]-[AdTracker]-4.3.0", "Error parsing ttl", exception);
        return false;
    }
    ...
    private static long j()
    {
        ...
        (new RetryMechanism(i1 - 1, j1, n)).rescheduleTimer(new a());
        synchronized (d)
        {
            d.wait(i2);
        }
...
_L2:
        Log.internal("[InMobi]-[AdTracker]-4.3.0", "Failed to get wait time", exception1);
        return l1;
        exception1;
...
_L1:
    ...
    private static void k()
    {
        ...
        Log.internal("[InMobi]-[AdTracker]-4.3.0", (new StringBuilder()).append("Fetch Wait time URL: ").append(s).toString());
...
label0:
        {
            ...
            try
            {
                ...
                Log.internal("[InMobi]-[AdTracker]-4.3.0", (new StringBuilder()).append("Wait time received for referrer: ").append(s1).toString());
            ...
            {
                Log.internal("[InMobi]-[AdTracker]-4.3.0", "Error fetching wait time for referrer", exception1);
            }
            break MISSING_BLOCK_LABEL_197;
        }
        exception;
        Log.internal("[InMobi]-[AdTracker]-4.3.0", "Error fetching wait time for referrer", exception);
        httpresponse = null;
          goto _L1
        return;
    ...
    public static void notifyThread()
    {
        ...
        {
            Log.internal("[InMobi]-[AdTracker]-4.3.0", "Failed to notify thread", exception);
        }
        return;
    }
...
_L1:
                    ...
                    catch (Exception exception2)
                    {
                        ...
                        {
                            Log.internal("[InMobi]-[AdTracker]-4.3.0", "Exception reporting goals", exception1);
                        }
                        return;
                    }
...
_L1:
        f.set(true);
        Log.debug("[InMobi]-[AdTracker]-4.3.0", (new StringBuilder()).append("Successfully uploaded goal: ").append(s1).toString());
_L4:
        return f.get();
_L2:
        Exception exception;
        ...
        {
            f.set(false);
            Log.debug("[InMobi]-[AdTracker]-4.3.0", (new StringBuilder()).append("Failed to upload goal: ").append(s1).toString());
        }
        ...
        catch (Exception exception)
        {
            f.set(false);
            Log.debug("[InMobi]-[AdTracker]-4.3.0", (new StringBuilder()).append("Failed to upload goal: ").append(s1).toString());
            Log.internal("[InMobi]-[AdTracker]-4.3.0", "Failed to report goal: ", exception);
        }
        if (true) goto _L4; else goto _L3
_L3:
    }
...
_L1:
        f.set(false);
        Log.debug("[InMobi]-[AdTracker]-4.3.0", (new StringBuilder()).append("Failed to upload goal: ").append(goal.getGoalName()).toString());
_L4:
        h.deinit(i1);
_L3:
        return g.get();
        ...
        {
            f.set(false);
            Log.internal("[InMobi]-[AdTracker]-4.3.0", "Failed to load webview Exception", exception);
        }
        if (true) goto _L3; else goto _L2
_L2:
        f.set(true);
        Log.debug("[InMobi]-[AdTracker]-4.3.0", (new StringBuilder()).append("Uploaded goal successfully: ").append(goal.getGoalName()).toString());
          goto _L4
    }
