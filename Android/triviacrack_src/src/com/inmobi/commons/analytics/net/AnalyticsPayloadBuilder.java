...
_L2:
        ...
        exception1;
        Log.debug("[InMobi]-[Analytics]-4.3.0", "Events attribute map is incorrect. Not sending custom event map.");
          goto _L1
        Exception exception;
        exception;
        Log.internal("[InMobi]-[Analytics]-4.3.0", "Creation of events json object failed", exception);
          goto _L2
        return jsonarray;
...
_L3:
    ...
    private JSONObject a(String s, long l, Context context)
    {
        ...
        {
            Log.internal("[InMobi]-[Analytics]-4.3.0", "Creation of session object failed", jsonexception);
            return jsonobject;
        }
        return jsonobject;
    }
    ...
    private JSONObject a(JSONObject jsonobject, JSONArray jsonarray)
    {
        ...
        {
            Log.internal("[InMobi]-[Analytics]-4.3.0", "Session addition to payload failed");
        }
        try
        {
        ...
        {
            Log.internal("[InMobi]-[Analytics]-4.3.0", "Events addition to payload failed");
            return jsonobject1;
        }
        return jsonobject1;
    }
    ...
    {
        Log.debug("[InMobi]-[Analytics]-4.3.0", "PayloadBuilder->getPayloadList:");
