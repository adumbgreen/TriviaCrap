    ...
    public WebviewLoader(Context context)
    {
            ...
            implements Runnable
        {
            ...
            public void run()
            {
                ...
                {
                    Log.internal("[InMobi]-[Network]-4.3.0", "Exception init webview", exception);
                }
            }
    ...
    public void deinit(int i)
    {
            ...
            implements Runnable
        {
            ...
            public void run()
            {
                ...
                {
                    Log.internal("[InMobi]-[Network]-4.3.0", "Exception deinit webview ", exception);
                }
            }
    ...
    public void loadInWebview(String s, HashMap hashmap)
    {
            ...
            implements Runnable
        {
            ...
            public void run()
            {
                ...
                {
                    Log.internal("[InMobi]-[Network]-4.3.0", "Exception load in webview", exception);
                }
            }
    ...
    public void stopLoading()
    {
            ...
            implements Runnable
        {
            ...
            public void run()
            {
                ...
                {
                    Log.internal("[InMobi]-[Network]-4.3.0", "Exception stop loading", exception);
                }
            }
