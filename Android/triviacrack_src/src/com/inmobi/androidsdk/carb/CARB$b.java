...
_L4:
        ...
        Log.internal("[InMobi]-[CARB]-4.3.0", (new StringBuilder()).append("RESPONSE: ").append(s2).toString());
        s3 = new String(InternalSDKUtil.DeAe(Base64.decode(s2.getBytes(), 0), CARB.c(a), CARB.d(a)));
        s4 = s3;
_L16:
        if (s4 == null) goto _L11; else goto _L10
_L10:
        Log.internal("[InMobi]-[CARB]-4.3.0", (new StringBuilder()).append("Get list after decryption: ").append(s4).toString());
...
_L14:
        ...
        return -1;
        exception1;
        Log.internal("[InMobi]-[CARB]-4.3.0", "Exception in carb ", exception1);
        s4 = null;
          goto _L16
_L11:
