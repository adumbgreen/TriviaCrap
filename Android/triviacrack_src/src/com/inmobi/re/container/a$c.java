    ...
    implements android.content.ogInterface.OnClickListener
{
    ...
    class a extends WebChromeClient
    {
        ...
        public boolean onJsAlert(WebView webview, String s, String s1, JsResult jsresult)
        {
            ...
            try
            {
                (new android.app.AlertDialog.Builder(webview.getContext())).setTitle(s).setMessage(s1).setPositiveButton(0x104000a, new a.c(this, jsresult)).setCancelable(false).create().show();
            }
            catch (Exception exception)
            {
        ...
        public void onShowCustomView(View view, android.webkit.WebChromeClient.CustomViewCallback customviewcallback)
        {
            ...
            IMWebView.g(a).setOnTouchListener(new a.e());
