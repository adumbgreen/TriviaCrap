...
class b extends WebViewClient
{
    ...
    {
        Log.debug("[InMobi]-[RE]-4.3.0", (new StringBuilder()).append("IMWebView-> onLoadResource:").append(s).toString());
        String s1;
        try
        {
    ...
    {
        Log.debug("[InMobi]-[RE]-4.3.0", (new StringBuilder()).append("IMWebView-> onPageFinished, url: ").append(s).toString());
        if (IMWebView.a(a) != null)
        {
...
_L1:
    ...
    public void onPageStarted(WebView webview, String s, Bitmap bitmap)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.3.0", (new StringBuilder()).append("IMWebView-> onPageStarted url: ").append(s).append(" p ").append(a.getParent()).toString());
        if (a.getParent() == null)
        {
            IMWebView.a(a, true);
        }
    ...
    {
        Log.debug("[InMobi]-[RE]-4.3.0", (new StringBuilder()).append("IMWebView-> error: ").append(s).toString());
        if (IMWebView.a(a) != null)
        {
    ...
    {
        Log.debug("[InMobi]-[RE]-4.3.0", (new StringBuilder()).append("IMWebView-> shouldOverrideUrlLoading, url:").append(s).append("webview id").append(webview).toString());
