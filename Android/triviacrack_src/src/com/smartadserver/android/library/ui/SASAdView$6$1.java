...
class a extends Thread
{
    ...
    public void run()
    {
        ...
        {
            s = s.replace("\"mraid.js\"", (new StringBuilder()).append("\"").append(a.a).append("\"").toString());
        }
        b.b.a(new Runnable(s1, s) {
...
_L4:
            ...
            if (a != null)
            {
                ...
                if (!i.k.d())
                {
                    try
                    {
                        (new SASAdView._cls6._cls1(this, new URL(a))).start();
                    }
            ...
            i.post(new SASAdView._cls6._cls2());
            return;
        }
        ...
        // Unreferenced inner class com/smartadserver/android/library/ui/SASAdView$6$2

/* anonymous class */
        class SASAdView._cls6._cls2
            implements Runnable
        {
