    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        layoutparams = new android.widget.LayoutParams(j, k);
...
_L2:
        ...
        if (!g)
        {
            ...
            if (d2 < 1.0D)
            {
                ...
                android.widget.ut.LayoutParams layoutparams1;
...
_L4:
        ...
        youtparams = i.getLayoutParams();
        layoutparams1 = new android.widget.ut.LayoutParams(youtparams.width, youtparams.height);
        if (flag1)
        {
        ...
        if (a != null)
        {
            if (flag1)
            {
                i.j.setLayoutParams(layoutparams1);
                i.k.setVisibility(0);
            }
            if (!i.k.d())
            {
    ...
    _cls2.a(SASAdView sasadview, String s, int j, int k, int l, int i1, boolean flag, 
