...
public final class NativeErrorCode extends Enum
{
    ...
    static 
    {
        ...
        NativeErrorCode anativeerrorcode[] = new NativeErrorCode[14];
        anativeerrorcode[0] = EMPTY_AD_RESPONSE;
        anativeerrorcode[1] = INVALID_JSON;
        anativeerrorcode[2] = IMAGE_DOWNLOAD_FAILURE;
        anativeerrorcode[3] = INVALID_REQUEST_URL;
        anativeerrorcode[4] = UNEXPECTED_RESPONSE_CODE;
        anativeerrorcode[5] = SERVER_ERROR_RESPONSE_CODE;
        anativeerrorcode[6] = CONNECTION_ERROR;
        anativeerrorcode[7] = UNSPECIFIED;
        anativeerrorcode[8] = NETWORK_INVALID_REQUEST;
        anativeerrorcode[9] = NETWORK_TIMEOUT;
        anativeerrorcode[10] = NETWORK_NO_FILL;
        anativeerrorcode[11] = NETWORK_INVALID_STATE;
        anativeerrorcode[12] = NATIVE_ADAPTER_CONFIGURATION_ERROR;
        anativeerrorcode[13] = NATIVE_ADAPTER_NOT_FOUND;
        b = anativeerrorcode;
    }
}
