    ...
    implements Runnable
{
    ...
    // Unreferenced inner class com/admarvel/android/ads/AdMarvelActivity$InnerInterstitialJS$7

/* anonymous class */
    class AdMarvelActivity.InnerInterstitialJS._cls7
        implements android.content.DialogInterface.OnClickListener
    {
        ...
        public void onClick(DialogInterface dialoginterface, int i)
        {
            if (callback != null)
            {
                AdMarvelActivity.f(adMarvelActivity).post(new AdMarvelActivity.InnerInterstitialJS._cls7._cls1());
            }
