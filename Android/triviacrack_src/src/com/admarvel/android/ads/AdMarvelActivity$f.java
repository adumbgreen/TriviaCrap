...
_L2:
        ...
        cursor = contentresolver.query(android.provider.lendars.CONTENT_URI, new String[] {
...
_L13:
        ...
        uri = contentresolver.insert(android.provider.ents.CONTENT_URI, contentvalues);
...
_L10:
        if (l <= 0)
        {
            ...
            contentresolver.insert(android.provider.minders.CONTENT_URI, contentvalues1);
        }
...
_L17:
    ...
    public View(AdMarvelInternalWebView admarvelinternalwebview, AdMarvelActivity admarvelactivity, String s, String s1, String s2)
    {
    ...
    public View(AdMarvelInternalWebView admarvelinternalwebview, AdMarvelActivity admarvelactivity, String s, String s1, String s2, String s3, String s4, 
            String s5, int i1)
    {
        a = new SimpleDateFormat("yyyyMMddhhmm");
        b = null;
