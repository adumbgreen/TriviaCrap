...
public class MMBroadcastReceiver extends BroadcastReceiver
{
    ...
    public void intentStarted(MMAd mmad, String s)
    {
        if (s != null)
        {
            MMLog.c("MMBroadcastReceiver", (new StringBuilder()).append("Millennial Media started intent: ").append(s).toString());
        }
    }
    ...
    public void onReceive(Context context, Intent intent)
    {
        ...
        if (context.getPackageName().equals(s1))
        {
            ...
            MMLog.a("MMBroadcastReceiver", stringbuilder.append(s2).toString());
            ...
            if (s.equals("millennialmedia.action.ACTION_AD_SINGLE_TAP"))
            {
                onSingleTap(mmad);
                return;
            }
