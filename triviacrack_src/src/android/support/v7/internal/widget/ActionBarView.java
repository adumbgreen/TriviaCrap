...
public class ActionBarView extends AbsActionBarView
{
    ...
    public ActionBarView(Context context, AttributeSet attributeset)
    {
        ...
        mContentHeight = typedarray.getLayoutDimension(1, 0);
        typedarray.recycle();
...
_L2:
        ...
        {
            int k7 = homeview.getLeftOffset();
            l1 = i1 + (k7 + positionChild(homeview, i1 + k7, j1, k1));
        } else
        {
            l1 = i1;
        }
...
_L17:
        ...
        if (layoutparams1 != null)
        {
            k6 = i2 + layoutparams1.leftMargin;
            l6 = k2 - layoutparams1.rightMargin;
            i7 = layoutparams1.topMargin;
            j7 = layoutparams1.bottomMargin;
            j4 = i7;
            k3 = l6;
            l3 = k6;
            i4 = j7;
...
_L12:
        l5 = view.getMeasuredWidth();
        view.layout(i5, k5, i5 + l5, k5 + view.getMeasuredHeight());
        l3 + l5;
...
_L13:
        i6 = getPaddingTop();
        k5 = (getHeight() - getPaddingBottom() - i6 - view.getMeasuredHeight()) / 2;
          goto _L12
_L14:
        k5 = j4 + getPaddingTop();
          goto _L12
_L15:
        k5 = getHeight() - getPaddingBottom() - view.getMeasuredHeight() - i4;
          goto _L12
    }
    ...
    private class HomeView extends FrameLayout
    {
        ...
        protected void onLayout(boolean flag, int i, int j, int k, int l)
        {
            ...
            if (k1 != 8)
            {
                ...
                int l3 = i1 - j3 / 2;
                mUpView.layout(0, l3, k3, j3 + l3);
                int i4 = k3 + layoutparams1.leftMargin + layoutparams1.rightMargin;
                int _tmp = j1 - i4;
                i += i4;
                l1 = i4;
            }
            ...
            mIconView.layout(l2, i3, j2 + l2, i2 + i3);
        }
