...
class a extends WebViewClient
{
    ...
    static InterstitialImageView a(a a1)
    {
        return a1.c;
    }
    ...
    _cls1.a(InterstitialImageView interstitialimageview)
    {
        c = interstitialimageview;
        super();
        b = new Runnable() {

            final InterstitialImageView._cls1 a;
            ...
            public void run()
            {
                if (a.a)
                {
                    ...
                    InterstitialImageView.a(InterstitialImageView._cls1.a(a)).stopLoading();
                    InterstitialImageView.b(InterstitialImageView._cls1.a(a));
                    a.a = false;
                }
            }
            ...
            {
                a = InterstitialImageView._cls1.this;
                super();
            }
        };
    }
