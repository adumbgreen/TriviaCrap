...
class a extends WebViewClient
{
    ...
    _cls1.a(MdotMActivity mdotmactivity)
    {
        c = mdotmactivity;
        super();
        b = new Runnable() {

            final MdotMActivity._cls1 a;
            ...
            public void run()
            {
                if (a.a)
                {
                    ...
                    com.mdotm.android.view.MdotMActivity.a(com.mdotm.android.view.MdotMActivity._cls1.a(a)).stopLoading();
                    com.mdotm.android.view.MdotMActivity._cls1.a(a).b = false;
                    a.a = false;
                }
            }
