...
class b extends Thread
{
    ...
    public void run()
    {
        ...
        {
            a.c.post(new Runnable(b) {

                final MdotMBannerView._cls2 a;
                private final String b;

                public void run()
                {
                    MdotMBannerView.a(MdotMBannerView._cls2.a(a)).loadUrl(b);
                }

            
            {
                a = MdotMBannerView._cls2.this;
                b = s;
                super();
            }
            });
    ...
    _cls1.b(MdotMBannerView mdotmbannerview, String s)
    {
        a = mdotmbannerview;
        b = s;
        super();
