...
_L5:
        ...
        if (s != null && !s.equals("# --table-fields-end--")) goto _L2; else goto _L1
_L1:
        DatabaseFieldConfig databasefieldconfig;
        databasetableconfig.setFieldConfigs(arraylist);
        return;
_L2:
        if ((databasefieldconfig = DatabaseFieldConfigLoader.fromReader(bufferedreader)) == null) goto _L1; else goto _L3
_L3:
