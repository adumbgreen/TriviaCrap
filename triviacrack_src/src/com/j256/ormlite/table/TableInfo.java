    ...
    public TableInfo(DatabaseType databasetype, BaseDaoImpl basedaoimpl, DatabaseTableConfig databasetableconfig)
    {
        ...
        while (j < i) 
        {
            ...
            if (fieldtype2.isId() || fieldtype2.isGeneratedId() || fieldtype2.isGeneratedIdSequence())
            {
                if (fieldtype != null)
                {
                    throw new SQLException((new StringBuilder()).append("More than 1 idField configured for class ").append(dataClass).append(" (").append(fieldtype).append(",").append(fieldtype2).append(")").toString());
                }
...
label0:
    ...
    public String objectToString(Object obj)
    {
        ...
        while (j < i) 
        {
            ...
            {
                throw new IllegalStateException((new StringBuilder()).append("Could not generate toString of field ").append(fieldtype).toString(), exception);
            }
            j++;
        }
