...
public class MappedDelete extends BaseMappedStatement
{
    ...
    public int delete(DatabaseConnection databaseconnection, Object obj, ObjectCache objectcache)
    {
        ...
        {
            throw SqlExceptionUtil.create((new StringBuilder()).append("Unable to run delete stmt on object ").append(obj).append(": ").append(statement).toString(), sqlexception);
        }
    ...
    public int deleteById(DatabaseConnection databaseconnection, Object obj, ObjectCache objectcache)
    {
        ...
        {
            throw SqlExceptionUtil.create((new StringBuilder()).append("Unable to run deleteById stmt on id ").append(obj).append(": ").append(statement).toString(), sqlexception);
        }
        if (i <= 0 || objectcache == null)
        {
