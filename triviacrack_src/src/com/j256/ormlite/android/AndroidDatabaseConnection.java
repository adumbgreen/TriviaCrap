...
_L6:
        throw SqlExceptionUtil.create((new StringBuilder()).append("updating database failed: ").append(s).toString(), sqlexception);
        exception;
_L5:
        if (sqlitestatement != null)
        {
...
_L2:
    ...
    public int insert(String s, Object aobj[], FieldType afieldtype[], GeneratedKeyHolder generatedkeyholder)
    {
        ...
        android.database.SQLException sqlexception;
        sqlexception;
        throw SqlExceptionUtil.create((new StringBuilder()).append("inserting to database failed: ").append(s).toString(), sqlexception);
        Exception exception;
        exception;
        if (sqlitestatement != null)
        {
    ...
    public long queryForLong(String s, Object aobj[], FieldType afieldtype[])
    {
        Cursor cursor = null;
        long l;
        cursor = db.rawQuery(s, toStrings(aobj));
...
_L1:
    ...
    {
        Cursor cursor1 = db.rawQuery(s, toStrings(aobj));
        Cursor cursor = cursor1;
        AndroidDatabaseResults androiddatabaseresults;
        boolean flag;
        androiddatabaseresults = new AndroidDatabaseResults(cursor, objectcache);
        logger.trace("{}: queried for one result: {}", this, s);
        flag = androiddatabaseresults.first();
...
_L9:
        throw SqlExceptionUtil.create((new StringBuilder()).append("queryForOne from database failed: ").append(s).toString(), sqlexception1);
        Exception exception1;
        exception1;
_L7:
        if (cursor != null)
