    ...
    implements CompiledStatement
{
    ...
    static int execSql(SQLiteDatabase sqlitedatabase, String s, String s1, Object aobj[])
    {
        ...
        {
            throw SqlExceptionUtil.create((new StringBuilder()).append("Problems executing ").append(s).append(" Android statement: ").append(s1).toString(), sqlexception);
        }
        sqlitestatement1 = sqlitedatabase.compileStatement("SELECT CHANGES()");
        sqlitestatement = sqlitestatement1;
...
_L1:
        ...
        {
            throw SqlExceptionUtil.create((new StringBuilder()).append("Problems executing Android query: ").append(s).toString(), sqlexception);
        }
        s = null;
...
_L4:
    ...
    public void setObject(int i, Object obj, SqlType sqltype)
    {
        ...
        {
        default:
            throw new java.sql.SQLException((new StringBuilder()).append("Unknown sql argument type: ").append(sqltype).toString());
        ...
        case 14: // '\016'
        case 15: // '\017'
            throw new java.sql.SQLException((new StringBuilder()).append("Invalid Android type: ").append(sqltype).toString());
        }
    }
