...
public class DatabaseFieldConfig
{
    ...
    public static Method findSetMethod(Field field, boolean flag)
    {
        ...
        if (method1.getReturnType() != Void.TYPE)
        {
            ...
            if (flag)
            {
                throw new IllegalArgumentException((new StringBuilder()).append("Return type of set method ").append(s).append(" returns ").append(method1.getReturnType()).append(" instead of void").toString());
            }
        } else
        {
            method = method1;
