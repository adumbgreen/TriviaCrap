...
public class BigIntegerType extends BaseDataType
{
    ...
    public Object sqlArgToJava(FieldType fieldtype, Object obj, int i)
    {
        ...
        {
            throw SqlExceptionUtil.create((new StringBuilder()).append("Problems with column ").append(i).append(" parsing BigInteger string '").append(obj).append("'").toString(), illegalargumentexception);
        }
        return biginteger;
    }
