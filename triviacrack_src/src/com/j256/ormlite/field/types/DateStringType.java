...
public class DateStringType extends BaseDateType
{
    ...
    public Object sqlArgToJava(FieldType fieldtype, Object obj, int i)
    {
        ...
        {
            throw SqlExceptionUtil.create((new StringBuilder()).append("Problems with column ").append(i).append(" parsing date-string '").append(s).append("' using '").append(datestringformatconfig).append("'").toString(), parseexception);
        }
        return date;
    }
