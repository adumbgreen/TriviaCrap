...
public class BigDecimalStringType extends BaseDataType
{
    ...
    public Object sqlArgToJava(FieldType fieldtype, Object obj, int i)
    {
        ...
        {
            throw SqlExceptionUtil.create((new StringBuilder()).append("Problems with column ").append(i).append(" parsing BigDecimal string '").append(obj).append("'").toString(), illegalargumentexception);
        }
        return bigdecimal;
    }
