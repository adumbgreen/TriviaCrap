...
public class UuidType extends BaseDataType
{
    ...
    public Object sqlArgToJava(FieldType fieldtype, Object obj, int i)
    {
        ...
        {
            throw SqlExceptionUtil.create((new StringBuilder()).append("Problems with column ").append(i).append(" parsing UUID-string '").append(s).append("'").toString(), illegalargumentexception);
        }
        return uuid;
    }
