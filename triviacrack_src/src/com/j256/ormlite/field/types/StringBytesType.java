...
public class StringBytesType extends BaseDataType
{
    ...
    public Object javaToSqlArg(FieldType fieldtype, Object obj)
    {
        ...
        {
            throw SqlExceptionUtil.create((new StringBuilder()).append("Could not convert string with charset name: ").append(s1).toString(), unsupportedencodingexception);
        }
        return abyte0;
    }
    ...
    public Object sqlArgToJava(FieldType fieldtype, Object obj, int i)
    {
        ...
        {
            throw SqlExceptionUtil.create((new StringBuilder()).append("Could not convert string with charset name: ").append(s).toString(), unsupportedencodingexception);
        }
        return s1;
    }
