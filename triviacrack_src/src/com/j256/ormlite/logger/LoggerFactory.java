    ...
    private class LogType extends Enum
    {
        ...
        public Log createLog(String s)
        {
            ...
            catch (Exception exception)
            {
                ...
                locallog.log(Log.Level.WARNING, (new StringBuilder()).append("Unable to call constructor with single String argument for class ").append(logClassName).append(", so had to use local log: ").append(exception.getMessage()).toString());
                return locallog;
            }
            return log;
        }
