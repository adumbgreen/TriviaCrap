    ...
    implements CloseableIterable
{
    ...
    public void assignEmptyForeignCollection(Object obj, String s)
    {
        ...
        {
            logMessage(sqlexception, (new StringBuilder()).append("assignEmptyForeignCollection threw exception on ").append(s).toString());
    ...
    public transient int executeRaw(String s, String as[])
    {
        ...
        {
            logMessage(sqlexception, (new StringBuilder()).append("executeRaw threw exception on: ").append(s).toString());
            throw new RuntimeException(sqlexception);
        }
        return i;
    }
    ...
    public List queryForEq(String s, Object obj)
    {
        ...
        {
            logMessage(sqlexception, (new StringBuilder()).append("queryForEq threw exception on: ").append(s).toString());
            throw new RuntimeException(sqlexception);
        }
        return list;
    }
    ...
    public transient GenericRawResults queryRaw(String s, RawRowMapper rawrowmapper, String as[])
    {
        ...
        {
            logMessage(sqlexception, (new StringBuilder()).append("queryRaw threw exception on: ").append(s).toString());
            throw new RuntimeException(sqlexception);
        }
    ...
    public transient long queryRawValue(String s, String as[])
    {
        ...
        {
            logMessage(sqlexception, (new StringBuilder()).append("queryRawValue threw exception on: ").append(s).toString());
            throw new RuntimeException(sqlexception);
        }
        return l;
    }
    ...
    public int updateId(Object obj, Object obj1)
    {
        ...
        {
            logMessage(sqlexception, (new StringBuilder()).append("updateId threw exception on: ").append(obj).toString());
            throw new RuntimeException(sqlexception);
        }
        return i;
    }
    ...
    public transient int updateRaw(String s, String as[])
    {
        ...
        {
            logMessage(sqlexception, (new StringBuilder()).append("updateRaw threw exception on: ").append(s).toString());
            throw new RuntimeException(sqlexception);
        }
        return i;
    }
