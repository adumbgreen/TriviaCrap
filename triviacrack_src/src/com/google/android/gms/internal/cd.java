    ...
    implements android.media.MediaPlayer.OnCompletionListener, android.media.MediaPlayer.OnErrorListener, android.media.MediaPlayer.OnPreparedListener
{
    ...
    public cd(Context context, fz fz1)
    {
        super(context);
        a = fz1;
    ...
    private static void a(fz fz1, String s)
    {
        a(fz1, s, ((Map) (new HashMap(1))));
    }

    public static void a(fz fz1, String s, String s1)
    {
        boolean flag;
        byte byte0;
        HashMap hashmap;
        ...
        a(fz1, "error", ((Map) (hashmap)));
    }

    private static void a(fz fz1, String s, String s1, String s2)
    {
    ...
    private static void a(fz fz1, String s, Map map)
    {
        map.put("event", s);
        fz1.a("onVideoEvent", map);
    }
