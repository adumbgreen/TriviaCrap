...
public class fk
{
    ...
    public static boolean a(Context context)
    {
        ...
        if (i == 0)
        {
            fx.c("Please set theme of AdActivity to @android:style/Theme.Translucent to enable transparent background interstitial ad.");
            return false;
        }
        ...
        {
            fx.e("Fail to fetch AdActivity theme");
            fx.c("Please set theme of AdActivity to @android:style/Theme.Translucent to enable transparent background interstitial ad.");
            return false;
        }
        return false;
    ...
    public void a(aj aj1, long l)
    {
        ...
        d = e;
_L2:
        if (aj1.c == null || aj1.c.getInt("gw", 2) != 1)
        {
