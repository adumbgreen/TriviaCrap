...
public class dd
{
    ...
    public static PublicKey a(String s)
    {
        ...
        {
            fx.b("Invalid key specification.");
    ...
    public static boolean a(String s, String s1, String s2)
    {
        ...
        {
            fx.b("Purchase verification failed: missing data.");
            return false;
        } else
        {
            return a(a(s), s1, s2);
...
label0:
        {
            try
            {
                ...
                fx.b("Signature verification failed.");
            }
            catch (NoSuchAlgorithmException nosuchalgorithmexception)
            {
                fx.b("NoSuchAlgorithmException.");
                return false;
            }
