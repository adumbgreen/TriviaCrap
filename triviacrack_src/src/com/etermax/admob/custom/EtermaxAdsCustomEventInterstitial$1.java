...
_L2:
        ...
        try
        {
            ...
            EtermaxAdsCustomEventInterstitial.access$300(EtermaxAdsCustomEventInterstitial.this).a(new h() {

                final EtermaxAdsCustomEventInterstitial._cls1 this$1;

                public void contentLoadCompleted(Bitmap bitmap)
                {
                    EtermaxAdsCustomEventInterstitial.access$200(this$0).onReceivedAd();
                    a.c("admob ads", "finished loading custom image");
                    EtermaxAdsCustomEventInterstitial.access$402(this$0, bitmap);
                    EtermaxAdsCustomEventInterstitial.access$502(this$0, null);
                }
                ...
                public void contentLoadCompleted(WebView webview)
                {
                    ...
                    EtermaxAdsCustomEventInterstitial.access$502(this$0, webview);
                    EtermaxAdsCustomEventInterstitial.access$402(this$0, null);
                }

                public void contentLoadFailed(Exception exception1)
                {
                    EtermaxAdsCustomEventInterstitial.access$200(this$0).onFailedToReceiveAd();
                    a.c("admob ads", (new StringBuilder()).append("failed to load custom content: ").append(exception1.getMessage()).toString());
                }

            
            {
                this$1 = EtermaxAdsCustomEventInterstitial._cls1.this;
                super();
            }
            });
