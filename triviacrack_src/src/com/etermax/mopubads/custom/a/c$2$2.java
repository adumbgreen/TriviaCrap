...
/* anonymous class */
        ...
        implements a
    {
        ...
        public void adLoadingCompleted(com.smartadserver.android.library.d.a a1)
        {
            ...
            try
            {
                com.etermax.mopubads.custom.a.c.a(a).post(new c._cls2._cls1());
                return;
            }
        ...
        public void adLoadingFailed(Exception exception)
        {
            ...
            try
            {
                com.etermax.mopubads.custom.a.c.a(a).post(new c._cls2._cls2(this));
                return;
            }
        ...
        // Unreferenced inner class com/etermax/mopubads/custom/a/c$2$1
