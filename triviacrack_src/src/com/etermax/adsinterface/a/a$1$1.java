        ...
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            try
            {
                ...
                {
                    ((Activity)a).runOnUiThread(new a._cls1._cls1(this, a1));
                    return;
                }
            }
            catch (Exception exception)
            {
                if (a instanceof Activity)
                {
                    ((Activity)a).runOnUiThread(new a._cls1._cls2(exception));
                    return;
                } else
                {
        ...
        // Unreferenced inner class com/etermax/adsinterface/a/a$1$2
