...
// Referenced classes of package com.etermax.chat.widget:
//            a
...
public class KeyboardNotificatorRelativeLayout extends RelativeLayout
{
    ...
    private void a()
    {
        for (Iterator iterator = a.iterator(); iterator.hasNext(); ((a)iterator.next()).e()) { }
    }

    private void b()
    {
        for (Iterator iterator = a.iterator(); iterator.hasNext(); ((a)iterator.next()).f_()) { }
    }
    ...
    protected void onMeasure(int i, int j)
    {
        ...
        l = getHeight();
        if (l <= k + 100) goto _L2; else goto _L1
_L1:
        b();
_L4:
        super.onMeasure(i, j);
