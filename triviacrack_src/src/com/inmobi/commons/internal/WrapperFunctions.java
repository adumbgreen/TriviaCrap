...
public class WrapperFunctions
{
    ...
    private static void a(WebView webview, int i)
    {
        ...
        {
            Log.internal("[InMobi]-4.3.0", "Cannot set hardware accl", nosuchmethodexception);
            return;
        }
        catch (IllegalArgumentException illegalargumentexception)
        {
            Log.internal("[InMobi]-4.3.0", "Cannot set hardware accl", illegalargumentexception);
            return;
        }
        catch (IllegalAccessException illegalaccessexception)
        {
            Log.internal("[InMobi]-4.3.0", "Cannot set hardware accl", illegalaccessexception);
            return;
        }
        catch (InvocationTargetException invocationtargetexception)
        {
            Log.internal("[InMobi]-4.3.0", "Cannot set hardware accl", invocationtargetexception);
        }
    }
...
_L2:
        int j;
        if (android.os.Build.VERSION.SDK_INT >= 8 && ((j = activity.getWindowManager().getDefaultDisplay().getRotation()) == 1 || j == 2))
        {
            return 9;
        }
          goto _L1
...
_L2:
        ...
        {
            Log.internal("[InMobi]-4.3.0", "Cannot get display height", illegalargumentexception);
            return 0;
        }
        catch (IllegalAccessException illegalaccessexception)
        {
            Log.internal("[InMobi]-4.3.0", "Cannot get display height", illegalaccessexception);
            return 0;
        }
        catch (InvocationTargetException invocationtargetexception)
        {
            Log.internal("[InMobi]-4.3.0", "Cannot get display height", invocationtargetexception);
            return 0;
        }
        return j;
        nosuchmethodexception;
        method1 = android/view/Display.getMethod("getHeight", (Class[])null);
        method = method1;
        flag = false;
        continue; /* Loop/switch isn't completed */
        nosuchmethodexception1;
        Log.internal("[InMobi]-4.3.0", "Cannot get display height", nosuchmethodexception1);
        flag = false;
        method = null;
...
_L2:
        ...
        {
            Log.internal("[InMobi]-4.3.0", "Cannot get display width", illegalargumentexception);
            return 0;
        }
        catch (IllegalAccessException illegalaccessexception)
        {
            Log.internal("[InMobi]-4.3.0", "Cannot get display width", illegalaccessexception);
            return 0;
        }
        catch (InvocationTargetException invocationtargetexception)
        {
            Log.internal("[InMobi]-4.3.0", "Cannot get display width", invocationtargetexception);
            return 0;
        }
        return j;
        nosuchmethodexception;
        method1 = android/view/Display.getMethod("getWidth", (Class[])null);
        method = method1;
        flag = false;
        continue; /* Loop/switch isn't completed */
        nosuchmethodexception1;
        Log.internal("[InMobi]-4.3.0", "Cannot get display width", nosuchmethodexception1);
        flag = false;
        method = null;
        if (true) goto _L2; else goto _L1
_L1:
    ...
    public static int getParamConfigScreenSize()
    {
        ...
        {
            Log.internal("[InMobi]-4.3.0", "Cannot get screen size", nosuchfieldexception);
            return 0;
        }
        catch (Exception exception)
        {
            Log.internal("[InMobi]-4.3.0", "Cannot get screen size", exception);
            return 0;
        }
        i = 0;
        if (field == null)
    ...
    public static int getParamConfigSmallestScreenSize()
    {
        ...
        {
            Log.internal("[InMobi]-4.3.0", "Cannot get smallest screen size", nosuchfieldexception);
            return 0;
        }
        catch (Exception exception)
        {
            Log.internal("[InMobi]-4.3.0", "Cannot get smallest screen size", exception);
            return 0;
        }
        i = 0;
        if (field == null)
...
_L2:
        ...
        Log.internal("[InMobi]-4.3.0", "Cannot get fill parent param", nosuchfieldexception1);
        field = null;
        continue; /* Loop/switch isn't completed */
        Exception exception1;
        exception1;
        Log.internal("[InMobi]-4.3.0", "Cannot get fill parent param", exception1);
          goto _L4
        Exception exception;
        exception;
        com/inmobi/commons/internal/WrapperFunctions;
...
_L6:
    ...
    public static int getParamLandscapeOrientation(int i)
    {
        ...
        {
            Log.internal("[InMobi]-4.3.0", "Cannot get landscape orientation", nosuchfieldexception);
            return 0;
        }
        catch (Exception exception)
        {
            Log.internal("[InMobi]-4.3.0", "Cannot get landscape orientation", exception);
            return 0;
        }
        j = 0;
        if (field == null)
    ...
    public static int getParamPortraitOrientation(int i)
    {
        ...
        {
            Log.internal("[InMobi]-4.3.0", "Cannot get portrait orientation", nosuchfieldexception);
            return j;
        }
        catch (Exception exception)
        {
            Log.internal("[InMobi]-4.3.0", "Cannot get portrait orientation", exception);
            return j;
        }
        if (field == null)
        {
    ...
    public static String getSSLErrorUrl(SslError sslerror)
    {
        ...
        {
            Log.internal("[InMobi]-4.3.0", "Cannot get SSL Url", exception);
            return null;
        }
        return s;
    }
    ...
    public static Bitmap getVideoBitmap(String s)
    {
        ...
        {
            Log.internal("[InMobi]-4.3.0", "Cannot get video bitmap", exception);
            throw exception;
        }
        return bitmap;
    }
