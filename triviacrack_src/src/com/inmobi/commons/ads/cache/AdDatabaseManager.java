...
public class AdDatabaseManager
{
    ...
    protected void close()
    {
        ...
        {
            Log.internal("[InMobi]-4.3.0", "Failed to close ads db", exception);
        }
    }
    ...
    public AdData getAd(String s)
    {
        ...
        cursor.close();
        b.delete("ad", (new StringBuilder()).append("adid = ").append(addata.getAdId()).toString(), null);
        close();
_L2:
        this;
        JVM INSTR monitorexit ;
        ...
        exception1;
        Log.internal("[InMobi]-4.3.0", "Failed to get native ads from db", exception1);
        addata = null;
...
_L1:
    ...
    protected int getDBSize()
    {
        ...
        {
            Log.internal("[InMobi]-4.3.0", "Failed to get native ads from db", exception);
            return 0;
        }
        return i;
    }
...
_L2:
        ...
        Exception exception1;
        exception1;
        Log.internal("[InMobi]-4.3.0", "Failed to insert native ads to db", exception1);
        if (true) goto _L2; else goto _L1
_L1:
        Exception exception;
        exception;
    ...
    protected void open()
    {
        ...
        {
            Log.internal("[InMobi]-4.3.0", "Failed to open ads db", exception);
        }
    }
