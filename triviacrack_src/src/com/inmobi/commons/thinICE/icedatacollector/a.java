...
//            IceDataCollector, BuildSettings, ThinICEListener, ThinICEConfigSettings, 
//            Sample
            ...
            implements WifiScanListener
        {
            ...
            public void onResultsReceived(List list)
            {
                ...
                if (BuildSettings.DEBUG)
                {
                    ...
                    WifiInfo wifiinfo;
                    for (Iterator iterator1 = list1.iterator(); iterator1.hasNext(); Log.d("IceDataCollector", (new StringBuilder()).append("   + ").append(wifiinfo).toString()))
                    {
                        wifiinfo = (WifiInfo)iterator1.next();
                    }
