...
_L1:
        ...
        exception1;
        Log.internal("[InMobi]-4.3.0", "Unable to save all configs to persistent memory", exception1);
          goto _L1
        Exception exception;
        exception;
        jsonobject;
...
_L2:
        ...
        Log.internal("[InMobi]-4.3.0", "Configs not present in persistence. Using default configs.");
        s = a;
        b = new JSONObject(s);
_L3:
        jsonobject;
        ...
        if (b.toString().equals("{}"))
        {
            ...
            {
                Log.internal("[InMobi]-4.3.0", "Default JSON root is unable to parse? What sorcery is this?", jsonexception1);
            }
            return;
        }
          goto _L1
        ...
        ioexception;
        Log.internal("[InMobi]-4.3.0", "Unable to read configs from persistent memory", ioexception);
          goto _L3
        Exception exception;
        exception;
        jsonobject;
        ...
        jsonexception;
        Log.internal("[InMobi]-4.3.0", "Ill formed JSON while parsing from persistent memory", jsonexception);
          goto _L3
    }
