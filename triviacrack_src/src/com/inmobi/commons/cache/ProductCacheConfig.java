...
public class ProductCacheConfig extends ProductConfig
{
    ...
    public ProductCacheConfig(JSONObject jsonobject)
    {
        ...
        {
            Log.internal("[InMobi]-4.3.0", "JSON retrieved is invalid.");
        }
    }
    ...
    private void a()
    {
        ...
        {
            Log.internal("[InMobi]-4.3.0", (new StringBuilder()).append("Error connecting to url, or ").append(getUrl()).append(" did not return 200. Purge cache update.").toString(), exception);
            throw exception;
        }
        if (s == null)
        {
...
_L3:
        ...
        g = b.b(b1);
        Log.internal("[InMobi]-4.3.0", (new StringBuilder()).append("Product with url ").append(getUrl()).append(" accepted data ").append(getRawData()).toString());
        f.onCommit();
        return;
_L2:
    ...
    private b c()
    {
        ...
        url = new URL(s2);
        Log.internal("[InMobi]-4.3.0", (new StringBuilder()).append("Sending request to ").append(s2).append(" to retreive cache..").toString());
    ...
    public JSONObject toJSON()
    {
        ...
        JSONObject jsonobject1 = new JSONObject((new StringBuilder()).append("{expiry:").append(getExpiry()).append(",").append("maxRetry:").append(getMaxRetry()).append(",").append("retryInterval:").append(getRetryInterval()).append(",").append("protocol:").append(getProtocol()).append(",timestamp:").append(getTimestamp()).append("}").toString());
        ...
        jsonexception = jsonexception1;
_L2:
        Log.internal("[InMobi]-4.3.0", (new StringBuilder()).append("Ill formed JSON product(").append(getUrl()).append(") toString").toString(), jsonexception);
        return jsonobject1;
        jsonexception;
