...
public final class AnalyticsEventsWrapper
{
    ...
    {
        Log.debug("[InMobi]-[Analytics]-4.3.0", "IllegalArgumentException", new IllegalArgumentException(s));
    }
    ...
    private boolean a()
    {
        ...
        {
            Log.internal("[InMobi]-[Analytics]-4.3.0", "Please call InMobi.initialize or startSession before calling any events API");
            return false;
        }
        return true;
    }
...
_L3:
        ...
        Exception exception;
        exception;
        Log.internal("[InMobi]-[Analytics]-4.3.0", "Begin Section Exception", exception);
        return;
    }
...
_L3:
        ...
        Exception exception;
        exception;
        Log.internal("[InMobi]-[Analytics]-4.3.0", "End Section Exception", exception);
        return;
    }
    ...
    public void endSession(Map map)
    {
        ...
        {
            Log.internal("[InMobi]-[Analytics]-4.3.0", "End Session Exception", exception);
        }
    }
    ...
    public void startSession(String s, Map map)
    {
        ...
        {
            Log.internal("[InMobi]-[Analytics]-4.3.0", "Init exception", exception);
        }
    }
...
_L3:
        ...
        Exception exception;
        exception;
        Log.internal("[InMobi]-[Analytics]-4.3.0", "Tag Event Exception", exception);
        return;
    }
...
_L3:
        ...
        Exception exception;
        exception;
        Log.internal("[InMobi]-[Analytics]-4.3.0", "Tag Transaction Manually Exception", exception);
        return;
    }
