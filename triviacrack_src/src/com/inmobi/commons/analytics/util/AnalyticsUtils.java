...
public class AnalyticsUtils
{
    ...
    public static final String ANALYTICS_LOGGING_TAG = "[InMobi]-[Analytics]-4.3.0";
    ...
    public static void asyncPingInternal(String s)
    {
        ...
        Log.debug("[InMobi]-[Analytics]-4.3.0", (new StringBuilder()).append("Pinging URL: ").append(s1).toString());
        ...
        Log.debug("[InMobi]-[Analytics]-4.3.0", (new StringBuilder()).append("Async Ping Connection Response Code: ").append(httpurlconnection1.getResponseCode()).toString());
...
_L2:
        ...
        exception1;
_L5:
        Log.debug("[InMobi]-[Analytics]-4.3.0", "Error doing async Ping. ", exception1);
...
_L3:
    ...
    public static String compressPayload(String s)
    {
        ...
        {
            Log.internal("[InMobi]-[Analytics]-4.3.0", "Exception compress sdk payload.", exception);
            return null;
        }
        return s1;
    }
    ...
    public static String convertToJSON(Map map)
    {
        ...
        {
            Log.verbose("[InMobi]-[Analytics]-4.3.0", (new StringBuilder()).append("Analytics events - number of key-value pairs in attribute map exceeds ").append(getExtraParamsLimit()).toString());
            return null;
        }
...
_L5:
        ...
        Exception exception;
        exception;
        Log.internal("[InMobi]-[Analytics]-4.3.0", "Unable to convert map to JSON");
_L9:
        String s = null;
_L10:
        return s;
_L6:
        Log.verbose("[InMobi]-[Analytics]-4.3.0", (new StringBuilder()).append("Analytics events - value : ").append(s3).append(" ,exceeds inmobi's limitation of ").append(getMaxstring()).append(" characters.").toString());
        return null;
_L4:
        Log.verbose("[InMobi]-[Analytics]-4.3.0", (new StringBuilder()).append("Analytics events - key : ").append(s2).append(" ,exceeds inmobi's limitation of ").append(getMaxparamskey()).append(" characters.").toString());
        return null;
_L2:
...
_L8:
    ...
    public static String getAppVersion(Context context)
    {
        ...
        {
            Log.internal("[InMobi]-[Analytics]-4.3.0", "Error retrieving application version");
            return null;
        }
        return s;
    }
    ...
    public static String getApplicationName(Context context)
    {
        ...
        {
            Log.internal("[InMobi]-[Analytics]-4.3.0", "Error retrieving application name");
            return null;
        }
        return s;
    }
