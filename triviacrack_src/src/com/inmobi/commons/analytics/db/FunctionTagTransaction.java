...
label1:
        ...
        jsonexception;
        Log.debug("[InMobi]-[Analytics]-4.3.0", "Error sending transaction info. Transaction details invalid");
        Log.internal("[InMobi]-[Analytics]-4.3.0", "Failed transaction", jsonexception);
        return null;
_L9:
        Exception exception2;
        Log.debug("[InMobi]-[Analytics]-4.3.0", "Error sending transaction info. Bundle details invalid");
        Log.internal("[InMobi]-[Analytics]-4.3.0", "Failed to send extra params transaction", exception2);
        analyticsevent = analyticsevent1;
          goto _L8
        Exception exception;
        exception;
        Log.internal("[InMobi]-[Analytics]-4.3.0", "Exception in tag transaction", exception);
_L2:
        return null;
        exception2;
          goto _L9
...
_L5:
        ...
        Exception exception;
        exception;
        Log.internal("[InMobi]-[Analytics]-4.3.0", "Failed to set purchase bundle info", exception);
        return analyticsevent;
        i++;
