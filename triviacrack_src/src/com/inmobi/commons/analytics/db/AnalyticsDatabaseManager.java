...
public final class AnalyticsDatabaseManager
{
    ...
    private AnalyticsEvent a(Cursor cursor)
    {
        ...
        l = cursor.getLong(1);
        s = Long.toString(l);
        Log.debug("[InMobi]-[Analytics]-4.3.0", (new StringBuilder()).append("IMAppDatabaseManager->").append(analyticsevent.getEventType()).append("-").append(l).toString());
...
_L5:
    ...
    {
        Log.debug("[InMobi]-[Analytics]-4.3.0", (new StringBuilder()).append("IMAppDatabaseManager->insertEvents-").append(analyticsevent.getEventType()).toString());
        ...
        {
            Log.debug("[InMobi]-[Analytics]-4.3.0", "Database full");
        }
    ...
    {
        Log.debug("[InMobi]-[Analytics]-4.3.0", "IMAppDatabaseManager->deleteEvents");
    ...
    private List c()
    {
        Log.debug("[InMobi]-[Analytics]-4.3.0", "IMAppDatabaseManager->getEvents");
        ArrayList arraylist = new ArrayList();
        if (!b.isOpen())
        {
            android.util.Log.v("[InMobi]-[Analytics]-4.3.0", "IMAppDatabaseManager->getEvents()-database is not open");
            return arraylist;
        }
...
_L2:
        ...
        exception1;
        Log.internal("[InMobi]-[Analytics]-4.3.0", "Error deleting from DB.");
...
_L2:
        ...
        Exception exception1;
        exception1;
        Log.internal("[InMobi]-[Analytics]-4.3.0", "Error reading events from DB.");
        obj = new ArrayList();
        if (true) goto _L2; else goto _L1
_L1:
        Exception exception;
...
_L2:
        ...
        Exception exception1;
        exception1;
        Log.internal("[InMobi]-[Analytics]-4.3.0", "Error in inserting into DB.", exception1);
