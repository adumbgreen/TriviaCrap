...
_L3:
        ...
        for (Iterator iterator1 = linkedhashmap.keySet().iterator(); iterator1.hasNext(); stringbuilder.append(","))
        {
            ...
            stringbuilder.append((new StringBuilder()).append(" ").append(s4).append(" ").append(columndata.getDataType().toString()).toString());
        ...
        Exception exception;
        exception;
        Log.internal("[InMobi]-4.3.0", "Exception creating table", exception);
_L2:
        return;
_L4:
...
_L8:
        String s3 = s2.concat(" );");
        Log.internal("[InMobi]-4.3.0", (new StringBuilder()).append("Table: ").append(s3).toString());
...
_L6:
    ...
    public void close()
    {
        ...
        {
            Log.internal("[InMobi]-4.3.0", "Failed to close  db", exception);
        }
    }
...
_L2:
        ...
        exception1;
        Log.internal("[InMobi]-4.3.0", "Failed to insert to db", exception1);
        i1 = -1;
...
_L2:
        ...
        Exception exception1;
        exception1;
        Log.internal("[InMobi]-4.3.0", "Failed to execute db query", exception1);
        cursor = null;
        if (true) goto _L2; else goto _L1
_L1:
        Exception exception;
...
_L3:
        ...
        Exception exception1;
        exception1;
        Log.internal("[InMobi]-4.3.0", "Failed to all rows", exception1);
        cursor = null;
          goto _L5
        Exception exception;
        exception;
...
_L2:
        ...
        Exception exception1;
        exception1;
        Log.internal("[InMobi]-4.3.0", "Failed to get number of rows", exception1);
        i1 = 0;
          goto _L5
        Exception exception;
        exception;
...
_L2:
        ...
        Exception exception1;
        exception1;
        Log.internal("[InMobi]-4.3.0", "Failed to table size ", exception1);
        i1 = 0;
        if (true) goto _L2; else goto _L1
_L1:
        Exception exception;
...
_L1:
    ...
    public void onUpgrade(SQLiteDatabase sqlitedatabase, int i1, int j1)
    {
        ...
        {
            Log.internal("[InMobi]-4.3.0", "Exception Deleting table", exception);
            return;
        }
    ...
    public void open()
    {
        ...
        {
            Log.internal("[InMobi]-4.3.0", "Failed to open  db", exception);
        }
    }
