...
public class InMobiAnalytics
{
    ...
    public static void beginSection(String s, Map map)
    {
        ...
        {
            Log.debug("[InMobi]-[Analytics]-4.3.0", "Please pass a valid Section Name");
        }
    }
    ...
    public static void reportCustomGoal(String s)
    {
        ...
        {
            Log.internal("[InMobi]-[Analytics]-4.3.0", "Unable to report custom goal due to unexpected exception.", exception);
        }
    }
    ...
    public static void tagEvent(String s, Map map)
    {
        ...
        {
            Log.internal("[InMobi]-[Analytics]-4.3.0", "Unable to tag event due to unexpected exception.", exception);
        }
    }
    ...
    public static void tagTransactionManually(Intent intent, Bundle bundle)
    {
        ...
        {
            Log.internal("[InMobi]-[Analytics]-4.3.0", "Unable to tag transaction due to unexpected exception.", exception);
        }
    }
}
