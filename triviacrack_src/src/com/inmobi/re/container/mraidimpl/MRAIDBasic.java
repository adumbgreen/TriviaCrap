...
public class MRAIDBasic
{
    ...
    public void getCurrentPosition()
    {
        ...
        f = 0.0F;
        Log.debug("[InMobi]-[RE]-4.3.0", "IMWebView-> getCurrentPosition");
...
_L3:
        ...
        l = 0;
_L6:
        Log.debug("[InMobi]-[RE]-4.3.0", "Failed to get current position");
        try
        {
            jsonobject.put("x", l);
            jsonobject.put("y", k);
...
_L7:
    ...
    public void getDefaultPosition()
    {
        ...
        JSONObject jsonobject;
        f = 0.0F;
        Log.debug("[InMobi]-[RE]-4.3.0", "IMWebView-> getDefaultPosition");
        jsonobject = new JSONObject();
        if (!a.isViewable()) goto _L2; else goto _L1
_L1:
        int j;
...
_L6:
        ...
        Log.debug("[InMobi]-[RE]-4.3.0", (new StringBuilder()).append("Failed to get default position").append(exception1.getMessage()).toString());
        try
        {
            jsonobject.put("x", j);
            jsonobject.put("y", i);
...
_L7:
    ...
    public void open(String s)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.3.0", (new StringBuilder()).append("IMWebView-> open:").append(s).toString());
        ...
        catch (Exception exception1)
        {
            ...
            {
                Log.debug("[InMobi]-[RE]-4.3.0", "Failed to perform mraid Open");
                return;
            }
