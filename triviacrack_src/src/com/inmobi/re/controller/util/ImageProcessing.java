...
public class ImageProcessing
{
    ...
    public static Bitmap getCompressedBitmap(String s, Context context)
    {
        ...
        {
            Log.debug("[InMobi]-[RE]-4.3.0", ioexception.getMessage(), ioexception);
            return null;
        }
        j = 1;
...
_L3:
        ...
        Log.debug("[InMobi]-[RE]-4.3.0", (new StringBuilder()).append("bitmap size - width: ").append(bitmap1.getWidth()).append(", height: ").append(bitmap1.getHeight()).toString());
        return bitmap1;
_L2:
