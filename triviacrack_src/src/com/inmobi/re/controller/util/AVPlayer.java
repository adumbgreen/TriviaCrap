    ...
    implements android.media.MediaPlayer.OnCompletionListener, android.media.MediaPlayer.OnErrorListener, android.media.MediaPlayer.OnPreparedListener
{
    ...
    private static String a(String s1)
    {
        ...
        if ((0x80 & abyte0[i1]) > 0)
        {
            stringbuffer.append((new StringBuilder()).append("%").append(UIDHelper.byteToHex(abyte0[i1])).toString());
    ...
    private void d()
    {
        ...
        {
            Log.internal("[InMobi]-[RE]-4.3.0", "IMAVPlayer: unable to remove view");
            return;
        }
        if (viewgroup == null)
        {
    ...
    public void hide()
    {
        ...
        {
            Log.internal("[InMobi]-[RE]-4.3.0", "IMAVPlayer: unable to hide video");
        }
    }
    ...
    public void mute()
    {
        if (s != null && !t)
        {
            ...
            {
                Log.internal("[InMobi]-[RE]-4.3.0", "IMAVPlayer: unable to set volume (mute)");
            }
            g();
        }
    }
    ...
    {
        Log.debug("[InMobi]-[RE]-4.3.0", "AVPlayer-> onCompletion");
        ...
        {
            Log.internal("[InMobi]-[RE]-4.3.0", "IMAvplayer onCompletion exception ", exception);
        }
        return;
        if (a.exitOnComplete())
        {
    ...
    {
        Log.debug("[InMobi]-[RE]-4.3.0", (new StringBuilder()).append("AVPlayer-> Player error : ").append(i1).toString());
        f();
        releasePlayer(false);
        if (b != null)
        {
    ...
    {
        Log.debug("[InMobi]-[RE]-4.3.0", (new StringBuilder()).append("AVPlayer-> onIMVisibilityChanged: ").append(flag).toString());
        if (flag && !pseudoPause)
        {
    ...
    public void onPrepared(MediaPlayer mediaplayer)
    {
        ...
        if (t)
        {
            ...
            {
                Log.internal("[InMobi]-[RE]-4.3.0", "IMAVPlayer: unable to set volume");
            }
        }
        Log.debug("[InMobi]-[RE]-4.3.0", "AVPlayer-> onPrepared");
        f();
        if (b != null)
        {
            b.onPrepared(this);
    ...
    protected void onWindowVisibilityChanged(int i1)
    {
        ...
        {
            Log.internal("[InMobi]-[RE]-4.3.0", "IMAVPlayer: onWindowVisibilityChanged: Something went wrong");
            return;
        }
        if (i1 == 0)
        {
...
_L2:
        ...
        i();
        Log.debug("[InMobi]-[RE]-4.3.0", "AVPlayer-> pause");
        b(g);
    ...
    public void setPlayData(com.inmobi.re.controller.JSController.PlayerProperties playerproperties, String s1)
    {
        ...
        if (o == null)
        {
            ...
            if (android.os.Build.VERSION.SDK_INT >= 8)
            {
                ...
                {
                    Log.internal("[InMobi]-[RE]-4.3.0", "IMAVPlayer: unable to get video bitmap");
                }
                return;
            }
        }
...
_L2:
        ...
        m = false;
        h();
        Log.debug("[InMobi]-[RE]-4.3.0", "AVPlayer-> start playing");
        if (l)
        {
            b(f);
        }
