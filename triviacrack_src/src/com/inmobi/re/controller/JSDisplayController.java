...
public class JSDisplayController extends JSController
{
    ...
    private JSController.ExpandProperties a(JSController.ExpandProperties expandproperties)
    {
        ...
        int l = k;
        Log.debug("[InMobi]-[RE]-4.3.0", (new StringBuilder()).append("Device current rotation: ").append(l).toString());
        Log.debug("[InMobi]-[RE]-4.3.0", (new StringBuilder()).append("Density of device: ").append(b).toString());
        ...
        Log.debug("[InMobi]-[RE]-4.3.0", (new StringBuilder()).append("Device Width: ").append(i).append(" Device height: ").append(j).toString());
        ...
        if (expandproperties.y < 0)
        {
            ...
            Log.debug("[InMobi]-[RE]-4.3.0", (new StringBuilder()).append("topStuff: ").append(expandproperties.topStuff).append(" ,bottomStuff: ").append(expandproperties.bottomStuff).toString());
        }
        Log.debug("[InMobi]-[RE]-4.3.0", (new StringBuilder()).append("loc 0: ").append(ai[0]).append(" loc 1: ").append(ai[1]).toString());
    ...
    public void close()
    {
        ...
        Log.debug("[InMobi]-[RE]-4.3.0", "JSDisplayController-> close");
    ...
    public void expand(String s)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.3.0", (new StringBuilder()).append("JSDisplayController-> expand: url: ").append(s).toString());
        try
        {
            ...
            {
                Log.debug("[InMobi]-[RE]-4.3.0", "JSDisplayController-> Already expanded state");
                return;
            }
        }
        catch (Exception exception)
        {
            Log.debug("[InMobi]-[RE]-4.3.0", "Exception while expanding the ad. ", exception);
            return;
        }
        if (imWebView.getStateVariable() == com.inmobi.re.container.IMWebView.ViewState.HIDDEN)
        {
            Log.debug("[InMobi]-[RE]-4.3.0", "JSDisplayController-> Expand cannot be called in hidden state. Doing nothing.");
            return;
        }
        ...
        Log.debug("[InMobi]-[RE]-4.3.0", (new StringBuilder()).append("JSDisplayController-> At the time of expand the properties are: Expandable width: ").append(temporaryexpProps.width).append(" Expandable height: ").append(temporaryexpProps.height).append(" Expandable orientation: ").append(temporaryexpProps.orientation).append(" Expandable lock orientation: ").append(temporaryexpProps.lockOrientation).append(" Expandable Modality: ").append(temporaryexpProps.isModal).append(" Expandable Use custom close ").append(temporaryexpProps.useCustomClose).toString());
        expProps = a(expProps);
        if (c == null)
        {
        ...
        imwebview.lockExpandOrientation(flag1, c.forceOrientation);
_L2:
        imWebView.expand(s, a(temporaryexpProps));
        return;
        imWebView.lockExpandOrientation(temporaryexpProps.lockOrientation, temporaryexpProps.orientation);
...
_L1:
    ...
    public String getOrientation()
    {
        ...
        try
        {
            ...
            Log.debug("[InMobi]-[RE]-4.3.0", (new StringBuilder()).append("JSDisplayController-> getOrientation: ").append(s).toString());
        }
        catch (Exception exception)
        {
            Log.debug("[InMobi]-[RE]-4.3.0", (new StringBuilder()).append("Error getOrientation: ").append("-1").toString(), exception);
            return "-1";
        }
        return s;
    }
    ...
    public String getPlacementType()
    {
        ...
        Log.debug("[InMobi]-[RE]-4.3.0", "JSDisplayController-> getPlacementType");
    ...
    public String getState()
    {
        ...
        Log.debug("[InMobi]-[RE]-4.3.0", "JSDisplayController-> getState");
    ...
    public boolean isViewable()
    {
        ...
        Log.debug("[InMobi]-[RE]-4.3.0", "JSDisplayController-> isViewable");
    ...
    public void open(String s)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.3.0", (new StringBuilder()).append("JSDisplayController-> open: url: ").append(s).toString());
        imWebView.openURL(s);
    }
    ...
    public void resize()
    {
        ...
        Log.debug("[InMobi]-[RE]-4.3.0", "JSDisplayController-> resize");
        try
        {
            if (imWebView.getStateVariable() == com.inmobi.re.container.IMWebView.ViewState.RESIZING)
            {
                Log.debug("[InMobi]-[RE]-4.3.0", "JSDisplayController-> Already resize state");
                return;
            }
        }
        catch (Exception exception)
        ...
        if (imWebView.getStateVariable() == com.inmobi.re.container.IMWebView.ViewState.HIDDEN)
        {
            Log.debug("[InMobi]-[RE]-4.3.0", "JSDisplayController-> Resize cannot be called in hidden state. Doing nothing.");
            return;
        }
        ...
        Log.debug("[InMobi]-[RE]-4.3.0", (new StringBuilder()).append("JSDisplayController-> At the time of resize the properties are: Resize width: ").append(resizeproperties.width).append(" Resize height: ").append(resizeproperties.height).append(" Resize offsetX: ").append(resizeproperties.offsetX).append(" Resize offsetY: ").append(resizeproperties.offsetY).append(" customClosePosition: ").append(resizeproperties.customClosePosition).append(" allowOffscreen: ").append(resizeproperties.allowOffscreen).toString());
    ...
    public void setExpandProperties(String s)
    {
        ...
        try
        {
            ...
            Log.debug("[InMobi]-[RE]-4.3.0", (new StringBuilder()).append("JSDisplayController-> ExpandProperties is set: Expandable Width: ").append(expProps.width).append(" Expandable height: ").append(expProps.height).append(" Expandable orientation: ").append(expProps.orientation).append(" Expandable lock orientation: ").append(expProps.lockOrientation).append(" Expandable Modality: ").append(expProps.isModal).append(" Expandable Use Custom close: ").append(expProps.useCustomClose).toString());
            imWebView.setCustomClose(expProps.useCustomClose);
            if (d == null)
            {
                imWebView.setOrientationPropertiesForInterstitial(expProps.lockOrientation, expProps.orientation);
            }
            return;
        }
        catch (Exception exception)
        {
            Log.debug("[InMobi]-[RE]-4.3.0", (new StringBuilder()).append("Exception while setting the expand properties ").append(exception).toString());
        }
    }
    ...
    public void setOrientationProperties(String s)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.3.0", (new StringBuilder()).append("JSDisplayController-> OrientationProperties is set: Expandable orientation: ").append(expProps.orientation).append(" Expandable lock orientation: ").append(expProps.lockOrientation).toString());
        imwebview = imWebView;
        boolean flag;
        if (!c.allowOrientationChange)
        {
            flag = true;
        } else
        {
        ...
        try
        {
            imwebview.setOrientationPropertiesForInterstitial(flag, c.forceOrientation);
            return;
        }
        catch (Exception exception)
        {
    ...
    public void setResizeProperties(String s)
    {
        ...
        try
        {
            ...
            Log.debug("[InMobi]-[RE]-4.3.0", (new StringBuilder()).append("JSDisplayController-> ResizeProperties is set: Resize Width: ").append(d.width).append(" Resize height: ").append(d.height).append(" Resize offsetX: ").append(d.offsetX).append(" Resize offsetY: ").append(d.offsetY).append(" customClosePosition: ").append(d.customClosePosition).append(" allowOffscreen: ").append(d.allowOffscreen).toString());
            return;
        }
        catch (Exception exception)
        {
    ...
    public void useCustomClose(boolean flag)
    {
        ...
        Log.debug("[InMobi]-[RE]-4.3.0", (new StringBuilder()).append("JSDisplayController-> useCustomClose").append(flag).toString());
