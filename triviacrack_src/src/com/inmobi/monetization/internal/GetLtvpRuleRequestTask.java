    ...
    implements Runnable
{
    ...
    public void run()
    {
        ...
        try
        {
            ...
            Log.debug("[InMobi]-[Monetization]", (new StringBuilder()).append("Getting LTVP rule: ").append(s).toString());
            ...
            if (!jsonobject.getBoolean("success"))
            {
                ...
                Log.debug("[InMobi]-[Monetization]", (new StringBuilder()).append("Received LTVP rule fetch failure: ").append(i).append(" : ").append(s3).toString());
                if (b != null)
                {
        ...
        Log.debug("[InMobi]-[Monetization]", (new StringBuilder()).append("Received LTVP rule fetch success: ").append(jsonobject1.toString()).toString());
