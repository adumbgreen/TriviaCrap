    ...
    implements IGetLtvpRuleRequestListener
{
    ...
    {
        Log.internal("[InMobi]-[Monetization]", (new StringBuilder()).append("Ltvp Rule error").append(ltvperrorcode.toString()).toString());
    }

    public void onLtvpGetRuleSucceeded(GetLtvpRulesRequest getltvprulesrequest, GetLtvpRulesResponse getltvprulesresponse)
    {
        Log.internal("[InMobi]-[Monetization]", (new StringBuilder()).append("Ltvp Rule received").append(getltvprulesresponse.getRules().toString()).toString());
