...
//            a, IMNativeListener, IMErrorCode
...
public class IMNative
{
    ...
    public void loadAd()
    {
        ...
        if (e != null && !"".equals(e))
        {
            ...
            try
            {
                String s = UIDHelper.getAndroidId(InternalSDKUtil.getContext());
                com.inmobi.commons.internal.Log.debug("[InMobi]-[Network]-4.3.0", (new StringBuilder()).append("Publisher device Id is ").append(UIDHelper.getODIN1(s)).toString());
            }
            catch (Exception exception)
            {
                com.inmobi.commons.internal.Log.internal("[InMobi]-[Network]-4.3.0", "Cannot get publisher device id", exception);
            }
            if (a() == a.a)
            {
    ...
    public void setKeywords(String s)
    {
        if (s == null || "".equals(s.trim()))
        {
            com.inmobi.commons.internal.Log.debug("[InMobi]-[Network]-4.3.0", "Keywords cannot be null or blank.");
            return;
        } else
        {
            h.setKeywords(s);
    ...
    public void setRefTagParam(String s, String s1)
    {
        if (s == null || "".equals(s.trim()))
        {
            com.inmobi.commons.internal.Log.debug("[InMobi]-[Network]-4.3.0", "Ref tag key cannot be null or blank.");
            return;
        }
        if (s1 == null || "".equals(s1.trim()))
        {
            com.inmobi.commons.internal.Log.debug("[InMobi]-[Network]-4.3.0", "RefTag value cannot be null or blank.");
            return;
        } else
        {
    ...
    public void setRequestParams(Map map)
    {
        ...
        {
            com.inmobi.commons.internal.Log.debug("[InMobi]-[Network]-4.3.0", "Request params cannot be null or empty.");
            return;
        } else
        {
    ...
    class com.inmobi.monetization.a
        implements INativeAdListener
    {
        ...
        public void onNativeRequestFailed(IMErrorCode imerrorcode)
        {
            ...
            {
                IMNative.a(a, a.f);
                IMNative.e(a).post(new a.a(this, imerrorcode));
                return;
            }
            catch (Exception exception)
            {
                com.inmobi.commons.internal.Log.debug("[InMobi]-[Monetization]", "Failed to give callback");
            }
        }
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            a.a(a a1, IMErrorCode imerrorcode)
            {
                b = a1;
                a = imerrorcode;
                super();
    ...
    // Unreferenced inner class com/inmobi/monetization/a$b
    class a.b
        implements Runnable
    {
