    ...
    implements HttpRequestCallback
{
    ...
    // Unreferenced inner class com/inmobi/androidsdk/impl/imai/IMAICore$a
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            try
            {
                ...
                requestresponsemanager.processClick(InternalSDKUtil.getContext(), new IMAICore.a.a(this));
                return;
            }
            catch (Exception exception)
            {
            ...
            IMAICore.a(String s, boolean flag, WeakReference weakreference)
            {
                a = s;
                b = flag;
                c = weakreference;
