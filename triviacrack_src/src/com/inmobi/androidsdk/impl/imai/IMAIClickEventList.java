...
_L1:
        ...
        Exception exception;
        exception;
        Log.internal("[InMobi]-[Network]-4.3.0", "Cant get click event", exception);
        return null;
        return null;
    }
...
_L2:
        ...
        exception1;
        Log.internal("[InMobi]-[Network]-4.3.0", "Cant reduce retry count", exception1);
...
_L2:
        ...
        Exception exception1;
        exception1;
        Log.internal("[InMobi]-[Network]-4.3.0", "Cant remove click event", exception1);
        flag = false;
        if (true) goto _L2; else goto _L1
_L1:
        Exception exception;
    ...
    {
        Log.internal("[InMobi]-[Network]-4.3.0", "Save ping events");
