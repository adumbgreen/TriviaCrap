...
public class IMAIController
{
    ...
    {
        Log.debug("[InMobi]-[Network]-4.3.0", "get platform version");
        return Integer.toString(android.os.Build.VERSION.SDK_INT);
    }

    public String getSdkVersion()
    {
        Log.debug("[InMobi]-[Network]-4.3.0", "get sdk version");
        return InMobi.getVersion();
    }

    public void log(String s)
    {
        Log.debug("[InMobi]-[Network]-4.3.0", s);
    }
    ...
    public void openEmbedded(String s)
    {
        ...
        try
        {
            Log.debug("[InMobi]-[Network]-4.3.0", "IMAI open Embedded");
        ...
        catch (Exception exception)
        {
            ...
            Log.internal("[InMobi]-[Network]-4.3.0", "IMAI openEmbedded failed", exception);
            return;
        }
    ...
    public void openExternal(String s)
    {
        ...
        try
        {
            Log.debug("[InMobi]-[Network]-4.3.0", "IMAI open external");
            if (!IMAICore.validateURL(s))
            {
        ...
        catch (Exception exception)
        {
            ...
            Log.internal("[InMobi]-[Network]-4.3.0", "IMAI openExternal failed", exception);
            return;
        }
    ...
    public void ping(String s, boolean flag)
    {
        ...
        try
        {
            Log.debug("[InMobi]-[Network]-4.3.0", "IMAI ping");
            if (!IMAICore.validateURL(s))
            {
        ...
        catch (Exception exception)
        {
            ...
            Log.internal("[InMobi]-[Network]-4.3.0", "IMAI ping failed", exception);
            return;
        }
    ...
    public void pingInWebView(String s, boolean flag)
    {
        ...
        try
        {
            Log.debug("[InMobi]-[Network]-4.3.0", "IMAI ping in webview");
            if (!IMAICore.validateURL(s))
            {
        ...
        catch (Exception exception)
        {
            ...
            Log.internal("[InMobi]-[Network]-4.3.0", "IMAI pingInWebView failed", exception);
            return;
        }
        if (s.contains("http") || s.contains("https"))
        {
