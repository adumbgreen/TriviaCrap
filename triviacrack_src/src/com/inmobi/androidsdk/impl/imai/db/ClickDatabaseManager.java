...
_L2:
        ...
        exception1;
        Log.internal("[InMobi]-[Network]-4.3.0", "Exception getting DB Manager Instance", exception1);
...
_L3:
        open();
        long l;
        for (Iterator iterator = arraylist.iterator(); iterator.hasNext(); delete("clickevent", (new StringBuilder()).append("clickid = ").append(l).toString(), null))
        {
        ...
        Exception exception1;
        exception1;
        Log.internal("[InMobi]-[Network]-4.3.0", "Exception deleting click events", exception1);
        boolean flag = false;
_L6:
        this;
        JVM INSTR monitorexit ;
...
_L2:
        ...
        Exception exception1;
        exception1;
        Log.internal("[InMobi]-4.3.0", "Failed to get clicks from db", exception1);
          goto _L6
        Exception exception;
        exception;
        throw exception;
    ...
    public int getNoOfEvents()
    {
        ...
        {
            Log.internal("[InMobi]-[Network]-4.3.0", "Exception getting no of click events", exception);
            return 0;
        }
        return i;
    }
...
_L2:
        ...
        Exception exception1;
        exception1;
        Log.internal("[InMobi]-4.3.0", "Failed to insert click event to db", exception1);
        if (true) goto _L2; else goto _L1
_L1:
        Exception exception;
        exception;
...
_L3:
        ...
        Exception exception1;
        exception1;
        Log.internal("[InMobi]-[Network]-4.3.0", "Exception updating retry count", exception1);
        boolean flag = false;
_L6:
        this;
        JVM INSTR monitorexit ;
