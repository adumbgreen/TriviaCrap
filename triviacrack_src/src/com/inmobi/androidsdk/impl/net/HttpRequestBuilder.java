...
label0:
        {
            ...
            {
                Log.internal("[InMobi]-[Network]-4.3.0", "Couldn't build post string in IMHttpRequestBuilder", exception);
                return null;
            }
            s = s1;
        }
...
_L1:
        ...
        if (!"".equals(s1))
        {
            stringbuilder.append((new StringBuilder()).append("&c-sid=").append(s1).toString());
        }
_L4:
        try
        {
...
_L2:
        ...
        exception1;
        Log.internal("[InMobi]-[Network]-4.3.0", "Exception getting cell tower id", exception1);
          goto _L4
    }
...
_L4:
        ...
        {
            stringbuffer.append((new StringBuilder()).append("&").append(s).toString());
        }
        ...
        if (s2 != null)
        {
            ...
            {
                Log.internal("[InMobi]-[Network]-4.3.0", (new StringBuilder()).append("Exception occured in an ad request").append(exception).toString());
            }
        }
