...
_L5:
        ...
        Log.internal("[InMobi]-[Network]-4.3.0", (new StringBuilder()).append("Retrying to ping in background after ").append(j / 1000).append(" secs").toString());
...
_L6:
        ...
        catch (Exception exception1)
        {
            try
            {
                Log.internal("[InMobi]-[Network]-4.3.0", "Exception pinging click in background", exception1);
                c.deinit();
                return;
            }
            // Misplaced declaration of an exception variable
            ...
            {
                Log.internal("[InMobi]-[Network]-4.3.0", "Exception ping to server ", exception);
            }
            return;
        }
