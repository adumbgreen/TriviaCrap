...
_L3:
    ...
    static String d()
    {
        long l = Double.doubleToLongBits(Math.random()) + 37L * (System.nanoTime() + (long)(37 * du.c(dl.a().b()).hashCode()));
    ...
    {
        File file;
        file = dl.a().b().getFileStreamPath(h());
...
_L3:
        File file1;
        String s = as[0];
        file1 = dl.a().b().getFileStreamPath(s);
