...
public class VastVideoDownloadTaskFactory
{
    ...
    {
        return a.a(vastvideodownloadtasklistener);
    }
    ...
    protected VastVideoDownloadTask a(com.mopub.mobileads.VastVideoDownloadTask.VastVideoDownloadTaskListener vastvideodownloadtasklistener)
    {
