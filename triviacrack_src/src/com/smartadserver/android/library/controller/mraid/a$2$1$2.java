...
/* anonymous class */
        ...
        implements Runnable
    {
        ...
        public void run()
        {
            ...
            {
                com.smartadserver.android.library.controller.mraid.a.a(a.c).a(new a._cls2._cls1._cls1());
            } else
            if (a.a == null && !"interstitial".equals(a.c.getPlacementType()))
            {
                com.smartadserver.android.library.controller.mraid.a.a(a.c).b(new a._cls2._cls1._cls2(this));
                return;
            }
        }
        ...
        // Unreferenced inner class com/smartadserver/android/library/controller/mraid/a$2$1$1

/* anonymous class */
        class a._cls2._cls1._cls1
