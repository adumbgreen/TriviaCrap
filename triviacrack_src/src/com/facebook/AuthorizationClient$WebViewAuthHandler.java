...
class this._cls0 extends this._cls0
{
    ...
    boolean tryAuthorize(final t request)
    {
        ...
        loginDialog = ((com.facebook.widget.alog)(new init>(getStartActivityDelegate().getActivityContext(), applicationId, bundle)).etE2E(e2e).etOnCompleteListener(tionid)).pleteListener();
        loginDialog.show();
        return true;
    }
