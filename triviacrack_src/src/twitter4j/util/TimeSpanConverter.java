    ...
    implements Serializable
{
    ...
    private String toTimeSpanString(int i)
    {
        ...
        if (i < 60)
        {
            MessageFormat messageformat2 = formats[1];
            Object aobj2[] = new Object[1];
            aobj2[0] = Integer.valueOf(i);
            return messageformat2.format(((Object) (aobj2)));
        }
        if (i < 2700)
        {
            int k = i / 60;
            ...
            {
                MessageFormat messageformat1 = formats[3];
                Object aobj1[] = new Object[1];
                aobj1[0] = Integer.valueOf(k);
                return messageformat1.format(((Object) (aobj1)));
            }
        }
        if (i < 6300)
        {
        ...
        {
            int j = (i + 900) / 3600;
            MessageFormat messageformat = formats[5];
